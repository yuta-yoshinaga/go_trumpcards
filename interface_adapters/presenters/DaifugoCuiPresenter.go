...
// Output ゲーム状態を文字列出力
func (p *DaifugoCuiPresenter) Output(dg *entities.Daifugo) string {
	res := "==========\n"
	res += "Daifugo (大富豪)\n"
	res += "==========\n"
...
func (p *DaifugoCuiPresenter) getPlayerName(dg *entities.Daifugo, idx int) string {
...
func (p *DaifugoCuiPresenter) getCardStr(card *entities.Card) string {
	if card == nil {
		return "??"
	}
