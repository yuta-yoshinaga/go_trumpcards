...
var gameNames = []string{
	...
	"doubt", "holdem", "omaha", "shortdeck", "hearts", "memory", "klondike", "freecell", "baccarat", "spades", "crazyeights", "ginrummy", "spider", "napoleon", "indianpoker", "videopoker", "deuceswild", "jokerpoker", "euchre", "pyramid", "cribbage", "threecard",
}
