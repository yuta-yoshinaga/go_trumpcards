...
func init() {
	...
	BindWebControllerFor("bigohilo",
		...
		controller.NewOmahaWebController)
	BindWebControllerFor("courchevelhilo",
		func() usecase.OmahaInteractorIF {
	...
	BindWebControllerFor("unsunkaruta",
		...
		controller.NewUnsunKarutaWebController)
	...
	BindWebControllerFor("eightgame",
