...
func newMockStreetsAndAlleysInteractor() *mockusecase.MockStreetsAndAlleysInteractor {
	return new(mockusecase.MockStreetsAndAlleysInteractor)
}

func TestStreetsAndAlleysCuiControllerQuit(t *testing.T) {
	bi := newMockStreetsAndAlleysInteractor()
	c := NewStreetsAndAlleysCuiController(bi)
	assert.Equal(t, "bye.", c.Exec("q"))
	assert.Equal(t, "bye.", c.Exec("quit"))
}

func TestStreetsAndAlleysCuiControllerReset(t *testing.T) {
	bi := newMockStreetsAndAlleysInteractor()
	c := NewStreetsAndAlleysCuiController(bi)
...
func TestStreetsAndAlleysCuiControllerGiveUp(t *testing.T) {
	bi := newMockStreetsAndAlleysInteractor()
	c := NewStreetsAndAlleysCuiController(bi)
...
func TestStreetsAndAlleysCuiControllerHint(t *testing.T) {
	bi := newMockStreetsAndAlleysInteractor()
	c := NewStreetsAndAlleysCuiController(bi)
...
func TestStreetsAndAlleysCuiControllerAutoComplete(t *testing.T) {
	bi := newMockStreetsAndAlleysInteractor()
	c := NewStreetsAndAlleysCuiController(bi)
...
func TestStreetsAndAlleysCuiControllerActionLog(t *testing.T) {
	bi := newMockStreetsAndAlleysInteractor()
	c := NewStreetsAndAlleysCuiController(bi)
...
func TestStreetsAndAlleysCuiControllerUndo(t *testing.T) {
	bi := newMockStreetsAndAlleysInteractor()
	c := NewStreetsAndAlleysCuiController(bi)
...
func TestStreetsAndAlleysCuiControllerMoveTableauToFoundation(t *testing.T) {
	bi := newMockStreetsAndAlleysInteractor()
	c := NewStreetsAndAlleysCuiController(bi)
...
func TestStreetsAndAlleysCuiControllerMoveTableauToTableau(t *testing.T) {
	bi := newMockStreetsAndAlleysInteractor()
	c := NewStreetsAndAlleysCuiController(bi)
...
func TestStreetsAndAlleysCuiControllerMoveErrors(t *testing.T) {
