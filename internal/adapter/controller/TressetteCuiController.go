...
// TressetteCuiController トレセッテのCUIコントローラークラス
type TressetteCuiController struct {
	ti usecase.TressetteInteractorIF
}

// NewTressetteCuiController コンストラクタ
func NewTressetteCuiController(ti usecase.TressetteInteractorIF) *TressetteCuiController {
	return &TressetteCuiController{ti: ti}
}
...
//	h / hint              → ヒント表示
//	log / l               → 棋譜表示
func (c *TressetteCuiController) Exec(command string) string {
