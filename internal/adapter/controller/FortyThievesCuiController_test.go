...
func newMockFortyThievesInteractor() *mockusecase.MockFortyThievesInteractor {
	return new(mockusecase.MockFortyThievesInteractor)
}

func TestFortyThievesCuiControllerQuit(t *testing.T) {
...
func TestFortyThievesCuiControllerReset(t *testing.T) {
	fi := newMockFortyThievesInteractor()
	c := NewFortyThievesCuiController(fi)
...
func TestFortyThievesCuiControllerDraw(t *testing.T) {
	fi := newMockFortyThievesInteractor()
	c := NewFortyThievesCuiController(fi)
...
func TestFortyThievesCuiControllerGiveUp(t *testing.T) {
	fi := newMockFortyThievesInteractor()
	c := NewFortyThievesCuiController(fi)
...
func TestFortyThievesCuiControllerHint(t *testing.T) {
	fi := newMockFortyThievesInteractor()
	c := NewFortyThievesCuiController(fi)
...
func TestFortyThievesCuiControllerAutoComplete(t *testing.T) {
	fi := newMockFortyThievesInteractor()
	c := NewFortyThievesCuiController(fi)
...
func TestFortyThievesCuiControllerActionLog(t *testing.T) {
	fi := newMockFortyThievesInteractor()
	c := NewFortyThievesCuiController(fi)
...
func TestFortyThievesCuiControllerUndo(t *testing.T) {
	fi := newMockFortyThievesInteractor()
	c := NewFortyThievesCuiController(fi)
...
func TestFortyThievesCuiControllerMoveWasteToTableau(t *testing.T) {
	fi := newMockFortyThievesInteractor()
	c := NewFortyThievesCuiController(fi)
...
func TestFortyThievesCuiControllerMoveWasteToFoundation(t *testing.T) {
	fi := newMockFortyThievesInteractor()
	c := NewFortyThievesCuiController(fi)
...
func TestFortyThievesCuiControllerMoveTableauToFoundation(t *testing.T) {
	fi := newMockFortyThievesInteractor()
	c := NewFortyThievesCuiController(fi)
...
func TestFortyThievesCuiControllerMoveTableauToTableau(t *testing.T) {
	fi := newMockFortyThievesInteractor()
	c := NewFortyThievesCuiController(fi)
...
func TestFortyThievesCuiControllerMoveErrors(t *testing.T) {
