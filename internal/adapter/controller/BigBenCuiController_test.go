...
func newMockBigBenInteractor() *mockusecase.MockBigBenInteractor {
	return new(mockusecase.MockBigBenInteractor)
}

func TestBigBenCuiControllerSimpleCommands(t *testing.T) {
	cases := []struct {
		method  string
		aliases []string
	}{
	...
	for _, tc := range cases {
		t.Run(tc.method, func(t *testing.T) {
			gi := newMockBigBenInteractor()
			c := NewBigBenCuiController(gi)
...
func TestBigBenCuiControllerQuit(t *testing.T) {
	c := NewBigBenCuiController(newMockBigBenInteractor())
	assert.Equal(t, "bye.", c.Exec("q"))
	assert.Equal(t, "bye.", c.Exec("quit"))
}

func TestBigBenCuiControllerMoves(t *testing.T) {
...
func TestBigBenCuiControllerMovePrompts(t *testing.T) {
...
func TestBigBenCuiControllerMoveErrors(t *testing.T) {
