...
// ThreeCardBragCuiController スリーカード・ブラグのCUIコントローラークラス
type ThreeCardBragCuiController struct {
	ti usecase.ThreeCardBragInteractorIF
}

// NewThreeCardBragCuiController コンストラクタ
func NewThreeCardBragCuiController(ti usecase.ThreeCardBragInteractorIF) *ThreeCardBragCuiController {
	return &ThreeCardBragCuiController{ti: ti}
}
...
//	h / hint                  → ヒント表示
//	l / log                   → 棋譜表示
func (c *ThreeCardBragCuiController) Exec(command string) string {
