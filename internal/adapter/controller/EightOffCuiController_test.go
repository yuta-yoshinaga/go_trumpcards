...
func newMockEightOffInteractor() *mockusecase.MockEightOffInteractor {
	return new(mockusecase.MockEightOffInteractor)
}

func TestEightOffCuiController_Quit(t *testing.T) {
	m := newMockEightOffInteractor()
	c := NewEightOffCuiController(m)

	assert.Equal(t, "bye.", c.Exec("q"))
	assert.Equal(t, "bye.", c.Exec("quit"))
}

func TestEightOffCuiController_Reset(t *testing.T) {
	m := newMockEightOffInteractor()
...
func TestEightOffCuiController_GiveUp(t *testing.T) {
	m := newMockEightOffInteractor()
...
func TestEightOffCuiController_Hint(t *testing.T) {
	m := newMockEightOffInteractor()
...
func TestEightOffCuiController_AutoComplete(t *testing.T) {
	m := newMockEightOffInteractor()
...
func TestEightOffCuiController_ActionLog(t *testing.T) {
	m := newMockEightOffInteractor()
...
func TestEightOffCuiController_Undo(t *testing.T) {
	m := newMockEightOffInteractor()
...
func TestEightOffCuiController_MoveTableauToFoundation(t *testing.T) {
	m := newMockEightOffInteractor()
...
func TestEightOffCuiController_MoveTableauToTableauWithCardIndex(t *testing.T) {
	m := newMockEightOffInteractor()
...
func TestEightOffCuiController_MoveTableauToTableauTopCard(t *testing.T) {
	m := newMockEightOffInteractor()
...
func TestEightOffCuiController_MoveTableauToFreeCell(t *testing.T) {
	m := newMockEightOffInteractor()
...
func TestEightOffCuiController_MoveFreeCellToTableau(t *testing.T) {
	m := newMockEightOffInteractor()
...
func TestEightOffCuiController_MoveFreeCellToFoundation(t *testing.T) {
	m := newMockEightOffInteractor()
...
func TestEightOffCuiController_MoveErrors(t *testing.T) {
	promptTests := []struct {
		name  string
		input string
	}{
...
func TestEightOffCuiController_MoveShorthand(t *testing.T) {
...
func TestEightOffCuiController_FoundationShorthand(t *testing.T) {
...
func TestEightOffCuiController_UnknownCommand(t *testing.T) {
	m := newMockEightOffInteractor()
	c := NewEightOffCuiController(m)
