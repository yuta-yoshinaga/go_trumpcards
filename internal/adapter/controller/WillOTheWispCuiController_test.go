...
func newMockWillOTheWispInteractor() *mockusecase.MockWillOTheWispInteractor {
	return new(mockusecase.MockWillOTheWispInteractor)
}

func TestWillOTheWispCuiControllerQuit(t *testing.T) {
	si := newMockWillOTheWispInteractor()
	c := NewWillOTheWispCuiController(si)
	assert.Equal(t, "bye.", c.Exec("q"))
	assert.Equal(t, "bye.", c.Exec("quit"))
}

func TestWillOTheWispCuiControllerReset(t *testing.T) {
	si := newMockWillOTheWispInteractor()
	c := NewWillOTheWispCuiController(si)
...
func TestWillOTheWispCuiControllerDeal(t *testing.T) {
	si := newMockWillOTheWispInteractor()
	c := NewWillOTheWispCuiController(si)
...
func TestWillOTheWispCuiControllerMoveTableauToTableau(t *testing.T) {
	si := newMockWillOTheWispInteractor()
	c := NewWillOTheWispCuiController(si)
...
func TestWillOTheWispCuiControllerMoveErrors(t *testing.T) {
...
func TestWillOTheWispCuiControllerGiveUp(t *testing.T) {
	si := newMockWillOTheWispInteractor()
	c := NewWillOTheWispCuiController(si)
...
func TestWillOTheWispCuiControllerHint(t *testing.T) {
	si := newMockWillOTheWispInteractor()
	c := NewWillOTheWispCuiController(si)
...
func TestWillOTheWispCuiControllerAutoComplete(t *testing.T) {
	si := newMockWillOTheWispInteractor()
	c := NewWillOTheWispCuiController(si)
...
func TestWillOTheWispCuiControllerActionLog(t *testing.T) {
	si := newMockWillOTheWispInteractor()
	c := NewWillOTheWispCuiController(si)
...
func TestWillOTheWispCuiControllerUndo(t *testing.T) {
	si := newMockWillOTheWispInteractor()
	c := NewWillOTheWispCuiController(si)
...
func TestWillOTheWispCuiControllerMoveShorthand(t *testing.T) {
...
func TestWillOTheWispCuiControllerUnknown(t *testing.T) {
	si := newMockWillOTheWispInteractor()
	c := NewWillOTheWispCuiController(si)
	result := c.Exec("xyz")
...
func TestWillOTheWispCuiControllerEmpty(t *testing.T) {
	si := newMockWillOTheWispInteractor()
	c := NewWillOTheWispCuiController(si)
	result := c.Exec("")
