...
func TestSevensWebController_Method(t *testing.T) {
	mockOutput := `{"players":[],"currentTurn":0,"tableMinVals":[0,7,7,7,7],"tableMaxVals":[0,7,7,7,7],"tablePlaced":[0,0,0,0,0],"config":{"tunnelEnabled":false,"tunnelSkipWidth":0,"jokerCount":0,"cpuStrategy":false,"maxPasses":5,"noJokerFinish":false,"jokerReclaimEnabled":false,"endStopEnabled":false,"jokerConsecutiveBanned":false},"gameEndFlag":false,"cpuActions":[],"humanAction":null,"message":""}`
	...
	qBody := `{"players":[],"currentTurn":0,"tableMinVals":[0,0,0,0,0],"tableMaxVals":[0,0,0,0,0],"tablePlaced":[0,0,0,0,0],"config":{"tunnelEnabled":false,"tunnelSkipWidth":0,"jokerCount":0,"cpuStrategy":false,"maxPasses":0,"noJokerFinish":false,"jokerReclaimEnabled":false,"endStopEnabled":false,"jokerConsecutiveBanned":false},"gameEndFlag":false,"cpuActions":[],"humanAction":null,"message":"bye."}`
	...
	t.Run("failed Exec other", func(t *testing.T) {
		...
		recorded.ContentTypeIsJson()
		recorded.BodyIs(`{"players":[],"currentTurn":0,"tableMinVals":[0,0,0,0,0],"tableMaxVals":[0,0,0,0,0],"tablePlaced":[0,0,0,0,0],"config":{"tunnelEnabled":false,"tunnelSkipWidth":0,"jokerCount":0,"cpuStrategy":false,"maxPasses":0,"noJokerFinish":false,"jokerReclaimEnabled":false,"endStopEnabled":false,"jokerConsecutiveBanned":false},"gameEndFlag":false,"cpuActions":[],"humanAction":null,"message":"Unsupported command."}`)
	})
	...
	t.Run("failed Exec command empty", func(t *testing.T) {
		...
		recorded.CodeIs(http.StatusBadRequest)
		recorded.ContentTypeIsJson()
		recorded.BodyIs(`{"players":[],"currentTurn":0,"tableMinVals":[0,0,0,0,0],"tableMaxVals":[0,0,0,0,0],"tablePlaced":[0,0,0,0,0],"config":{"tunnelEnabled":false,"tunnelSkipWidth":0,"jokerCount":0,"cpuStrategy":false,"maxPasses":0,"noJokerFinish":false,"jokerReclaimEnabled":false,"endStopEnabled":false,"jokerConsecutiveBanned":false},"gameEndFlag":false,"cpuActions":[],"humanAction":null,"message":"param error."}`)
	})
...
func TestSevensWebController_ResetWithConfig(t *testing.T) {
	mockOutput := `{"players":[],"currentTurn":0,"tableMinVals":[0,7,7,7,7],"tableMaxVals":[0,7,7,7,7],"tablePlaced":[0,0,0,0,0],"config":{"tunnelEnabled":true,"tunnelSkipWidth":0,"jokerCount":2,"cpuStrategy":true,"maxPasses":5,"noJokerFinish":false,"jokerReclaimEnabled":false,"endStopEnabled":false,"jokerConsecutiveBanned":false},"gameEndFlag":false,"cpuActions":[],"humanAction":null,"message":""}`
	...
	t.Run("reset with partial config calls ResetWithConfig with defaults", func(t *testing.T) {
		partialOutput := `{"players":[],"currentTurn":0,"tableMinVals":[0,7,7,7,7],"tableMaxVals":[0,7,7,7,7],"tablePlaced":[0,0,0,0,0],"config":{"tunnelEnabled":true,"tunnelSkipWidth":0,"jokerCount":0,"cpuStrategy":false,"maxPasses":5,"noJokerFinish":false,"jokerReclaimEnabled":false,"endStopEnabled":false,"jokerConsecutiveBanned":false},"gameEndFlag":false,"cpuActions":[],"humanAction":null,"message":""}`
		sgiMock := new(usecase.MockSevensInteractor)
	...
	t.Run("reset with maxPasses field calls ResetWithConfig", func(t *testing.T) {
		passesOutput := `{"players":[],"currentTurn":0,"tableMinVals":[0,7,7,7,7],"tableMaxVals":[0,7,7,7,7],"tablePlaced":[0,0,0,0,0],"config":{"tunnelEnabled":false,"tunnelSkipWidth":0,"jokerCount":0,"cpuStrategy":false,"maxPasses":3,"noJokerFinish":false,"jokerReclaimEnabled":false,"endStopEnabled":false,"jokerConsecutiveBanned":false},"gameEndFlag":false,"cpuActions":[],"humanAction":null,"message":""}`
		sgiMock := new(usecase.MockSevensInteractor)
	...
	t.Run("reset with only maxPasses field calls ResetWithConfig with default maxPasses", func(t *testing.T) {
		passesOutput := `{"players":[],"currentTurn":0,"tableMinVals":[0,7,7,7,7],"tableMaxVals":[0,7,7,7,7],"tablePlaced":[0,0,0,0,0],"config":{"tunnelEnabled":false,"tunnelSkipWidth":0,"jokerCount":0,"cpuStrategy":false,"maxPasses":0,"noJokerFinish":false,"jokerReclaimEnabled":false,"endStopEnabled":false,"jokerConsecutiveBanned":false},"gameEndFlag":false,"cpuActions":[],"humanAction":null,"message":""}`
		sgiMock := new(usecase.MockSevensInteractor)
		sgiMock.On("ResetWithConfig", mock.Anything).Return(passesOutput)
		factory := func() uc.SevensInteractorIF { return sgiMock }
		tswc := controller.NewSevensWebController(factory)
	...
	t.Run("reset with jokerReclaim field calls ResetWithConfig", func(t *testing.T) {
		jrOutput := `{"players":[],"currentTurn":0,"tableMinVals":[0,7,7,7,7],"tableMaxVals":[0,7,7,7,7],"tablePlaced":[0,0,0,0,0],"config":{"tunnelEnabled":false,"tunnelSkipWidth":0,"jokerCount":1,"cpuStrategy":false,"maxPasses":5,"noJokerFinish":false,"jokerReclaimEnabled":true,"endStopEnabled":false,"jokerConsecutiveBanned":false},"gameEndFlag":false,"cpuActions":[],"humanAction":null,"message":""}`
		sgiMock := new(usecase.MockSevensInteractor)
	...
	t.Run("reset with endStop field calls ResetWithConfig", func(t *testing.T) {
		esOutput := `{"players":[],"currentTurn":0,"tableMinVals":[0,7,7,7,7],"tableMaxVals":[0,7,7,7,7],"tablePlaced":[0,0,0,0,0],"config":{"tunnelEnabled":false,"tunnelSkipWidth":0,"jokerCount":0,"cpuStrategy":false,"maxPasses":5,"noJokerFinish":false,"jokerReclaimEnabled":false,"endStopEnabled":true,"jokerConsecutiveBanned":false},"gameEndFlag":false,"cpuActions":[],"humanAction":null,"message":""}`
		sgiMock := new(usecase.MockSevensInteractor)
	...
	t.Run("reset with tunnelSkipWidth field calls ResetWithConfig", func(t *testing.T) {
		tswOutput := `{"players":[],"currentTurn":0,"tableMinVals":[0,7,7,7,7],"tableMaxVals":[0,7,7,7,7],"tablePlaced":[0,0,0,0,0],"config":{"tunnelEnabled":false,"tunnelSkipWidth":3,"jokerCount":0,"cpuStrategy":false,"maxPasses":5,"noJokerFinish":false,"jokerReclaimEnabled":false,"endStopEnabled":false,"jokerConsecutiveBanned":false},"gameEndFlag":false,"cpuActions":[],"humanAction":null,"message":""}`
		sgiMock := new(usecase.MockSevensInteractor)
	...
	t.Run("reset with jokerConsecutiveBanned field calls ResetWithConfig", func(t *testing.T) {
		jcbOutput := `{"players":[],"currentTurn":0,"tableMinVals":[0,7,7,7,7],"tableMaxVals":[0,7,7,7,7],"tablePlaced":[0,0,0,0,0],"config":{"tunnelEnabled":false,"tunnelSkipWidth":0,"jokerCount":0,"cpuStrategy":false,"maxPasses":5,"noJokerFinish":false,"jokerReclaimEnabled":false,"endStopEnabled":false,"jokerConsecutiveBanned":true},"gameEndFlag":false,"cpuActions":[],"humanAction":null,"message":""}`
		sgiMock := new(usecase.MockSevensInteractor)
