...
// GanjifaCuiController ガンジファのCUIコントローラークラス
type GanjifaCuiController struct {
	di usecase.GanjifaInteractorIF
}

// NewGanjifaCuiController コンストラクタ
func NewGanjifaCuiController(di usecase.GanjifaInteractorIF) *GanjifaCuiController {
	return &GanjifaCuiController{di: di}
}
...
//	h / hint                 → ヒント表示
//	log / l                  → 棋譜表示
func (c *GanjifaCuiController) Exec(command string) string {
