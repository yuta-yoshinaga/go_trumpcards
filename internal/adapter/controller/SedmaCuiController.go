...
// SedmaCuiController セドマのCUIコントローラークラス
type SedmaCuiController struct {
	di usecase.SedmaInteractorIF
}

// NewSedmaCuiController コンストラクタ
func NewSedmaCuiController(di usecase.SedmaInteractorIF) *SedmaCuiController {
	return &SedmaCuiController{di: di}
}
...
//	h / hint                 → ヒント表示
//	log / l                  → 棋譜表示
func (c *SedmaCuiController) Exec(command string) string {
