...
func newMockBeleagueredCastleInteractor() *mockusecase.MockBeleagueredCastleInteractor {
	return new(mockusecase.MockBeleagueredCastleInteractor)
}

func TestBeleagueredCastleCuiControllerQuit(t *testing.T) {
	bi := newMockBeleagueredCastleInteractor()
	c := NewBeleagueredCastleCuiController(bi)
	assert.Equal(t, "bye.", c.Exec("q"))
	assert.Equal(t, "bye.", c.Exec("quit"))
}

func TestBeleagueredCastleCuiControllerReset(t *testing.T) {
	bi := newMockBeleagueredCastleInteractor()
	c := NewBeleagueredCastleCuiController(bi)
...
func TestBeleagueredCastleCuiControllerGiveUp(t *testing.T) {
	bi := newMockBeleagueredCastleInteractor()
	c := NewBeleagueredCastleCuiController(bi)
...
func TestBeleagueredCastleCuiControllerHint(t *testing.T) {
	bi := newMockBeleagueredCastleInteractor()
	c := NewBeleagueredCastleCuiController(bi)
...
func TestBeleagueredCastleCuiControllerAutoComplete(t *testing.T) {
	bi := newMockBeleagueredCastleInteractor()
	c := NewBeleagueredCastleCuiController(bi)
...
func TestBeleagueredCastleCuiControllerActionLog(t *testing.T) {
	bi := newMockBeleagueredCastleInteractor()
	c := NewBeleagueredCastleCuiController(bi)
...
func TestBeleagueredCastleCuiControllerUndo(t *testing.T) {
	bi := newMockBeleagueredCastleInteractor()
	c := NewBeleagueredCastleCuiController(bi)
...
func TestBeleagueredCastleCuiControllerMoveTableauToFoundation(t *testing.T) {
	bi := newMockBeleagueredCastleInteractor()
	c := NewBeleagueredCastleCuiController(bi)
...
func TestBeleagueredCastleCuiControllerMoveTableauToTableau(t *testing.T) {
	bi := newMockBeleagueredCastleInteractor()
	c := NewBeleagueredCastleCuiController(bi)
...
func TestBeleagueredCastleCuiControllerMoveErrors(t *testing.T) {
