...
// SpoilFiveCuiController スポイル・ファイブのCUIコントローラークラス
type SpoilFiveCuiController struct {
	di usecase.SpoilFiveInteractorIF
}

// NewSpoilFiveCuiController コンストラクタ
func NewSpoilFiveCuiController(di usecase.SpoilFiveInteractorIF) *SpoilFiveCuiController {
	return &SpoilFiveCuiController{di: di}
}
...
//	h / hint                 → ヒント表示
//	log / l                  → 棋譜表示
func (c *SpoilFiveCuiController) Exec(command string) string {
