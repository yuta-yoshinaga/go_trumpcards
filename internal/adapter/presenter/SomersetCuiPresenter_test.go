...
func setupSomersetCuiMockDefaults(bg *interfaces.MockSomersetGame) {
...
func TestSomersetCuiPresenter_Output(t *testing.T) {
	...
	t.Run("initial state", func(t *testing.T) {
		...
		setupSomersetCuiMockDefaults(bg)
		p := new(SomersetCuiPresenter)

		result := p.Output(bg, nil)
		assert.Contains(t, result, "Somerset")
	...
	t.Run("stalemate shows undo-to-escape guidance", func(t *testing.T) {
		...
		result := p.Output(bg, nil)
		assert.Contains(t, result, i18n.Tf("somerset.undoToEscape", "count", "3"))
	})
	...
	t.Run("empty column", func(t *testing.T) {
		...
		var emptyTableau [domain.SomersetTableauCnt][]*domain.SomersetTableauCard
	...
	t.Run("empty foundation", func(t *testing.T) {
		...
		var emptyFoundation [domain.SomersetFoundationCnt][]*domain.Card
...
func TestSomersetCuiPresenter_HintOutput(t *testing.T) {
