...
func (p *TrucoWebPresenter) buildTrickOutput(trick []*domain.TrucoTrickCard) []*controller.TrucoWebOutputTrickCard {
	return buildTrickCards(trick, func(tc *domain.TrucoTrickCard) *controller.TrucoWebOutputTrickCard {
