...
func setupCitadelCuiMockDefaults(bg *interfaces.MockCitadelGame) {
...
func TestCitadelCuiPresenter_Output(t *testing.T) {
	...
	t.Run("initial state", func(t *testing.T) {
		...
		setupCitadelCuiMockDefaults(bg)
	...
	t.Run("stalemate shows undo-to-escape guidance", func(t *testing.T) {
		...
		result := p.Output(bg, nil)
		assert.Contains(t, result, i18n.Tf("citadel.undoToEscape", "count", "3"))
	})
	...
	t.Run("empty column", func(t *testing.T) {
		...
		var emptyTableau [domain.CitadelTableauCnt][]*domain.CitadelTableauCard
	...
	t.Run("empty foundation", func(t *testing.T) {
		...
		var emptyFoundation [domain.CitadelFoundationCnt][]*domain.Card
...
func TestCitadelCuiPresenter_HintOutput(t *testing.T) {
...
func TestCitadelCuiPresenter_ActionLogOutput(t *testing.T) {
