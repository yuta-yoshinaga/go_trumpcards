...
func fillRikkenDefaults(m *interfaces.MockRikkenGame) {
	...
	m.On("IsDeclarerSideVisible", 0).Return(true).Maybe()
	m.On("IsDeclarerSide", 1).Return(false).Maybe()
	m.On("IsDeclarerSideVisible", 1).Return(false).Maybe()
	m.On("IsDeclarerSide", 2).Return(false).Maybe()
	m.On("IsDeclarerSideVisible", 2).Return(false).Maybe()
	m.On("IsDeclarerSide", 3).Return(false).Maybe()
	m.On("IsDeclarerSideVisible", 3).Return(false).Maybe()
