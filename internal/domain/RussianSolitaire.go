...
func (y *RussianSolitaire) GetHint() *RussianSolitaireHint {
	...
	h := yukonFamilyGetHint(y.tableau[:], RussianSolitaireFoundationCnt, func(tc *KlondikeTableauCard) *Card { return tc.Card }, func(tc *KlondikeTableauCard) bool { return tc.FaceUp }, y.canPlaceOnFoundation, y.canPlaceOnTableau)
	if h == nil {
		return nil
	}
	return &RussianSolitaireHint{FromCol: h.fromCol, CardIndex: h.cardIndex, ToZone: h.toZone, ToCol: h.toCol}
}
