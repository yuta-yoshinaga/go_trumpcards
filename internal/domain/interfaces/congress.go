...
// CongressGame コングレス ゲームインタフェース
type CongressGame interface {
	SolitaireGame
	...
	// GetHint ヒントを取得する
	GetHint() *domain.CongressHint
	// GetPhase 現在のフェーズを取得する
	GetPhase() domain.CongressPhase
	...
	GetTableau() [domain.CongressTableauCnt][]*domain.Card
	// GetFoundation 基礎札を取得する
	GetFoundation() [domain.CongressFoundationCnt][]*domain.Card
