...
// WhiteheadGame ホワイトヘッドゲームインタフェース
type WhiteheadGame interface {
	SolitaireGame
	...
	ResetWithConfig(cfg domain.WhiteheadConfig)
	// Draw 山札からカードをめくる
	Draw() error
	...
	// GetHint ヒントを取得する
	GetHint() *domain.WhiteheadHint
	// GetPhase 現在のフェーズを取得する
	GetPhase() domain.WhiteheadPhase
	...
	GetScoringMode() domain.WhiteheadScoringMode
