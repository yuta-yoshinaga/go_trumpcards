...
// WillOTheWispGame ウィル・オ・ザ・ウィスプゲームインタフェース
type WillOTheWispGame interface {
	SolitaireGame
	...
	// GetHint ヒントを取得する
	GetHint() *domain.WillOTheWispHint
	// GetPhase 現在のフェーズを取得する
	GetPhase() domain.WillOTheWispPhase
	...
	GetTableau() [domain.WillOTheWispTableauCnt][]*domain.WillOTheWispTableauCard
