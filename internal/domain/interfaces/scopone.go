...
// ScoponeGame スコポーネのゲームインタフェース (4 人 2 チーム)。
type ScoponeGame interface {
	BaseGame
	...
	SetConfig(config domain.ScoponeConfig)
	...
	GetLastRoundDetail() *domain.ScoponeScoreDetail
