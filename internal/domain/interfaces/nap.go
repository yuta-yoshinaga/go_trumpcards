...
// NapGame ナップ (Nap) のゲームインタフェース
type NapGame interface {
	BaseGame
	// Reset ゲームを初期化する
	Reset()
	...
	PlayerBid(bid domain.NapBid) error
	...
	SetConfig(cfg domain.NapConfig)

	// GetGameEndFlag ゲーム終了フラグを取得する
	GetGameEndFlag() bool
	// GetPhase 現在のフェーズを取得する
	GetPhase() domain.NapPhase
	...
	GetCurrentTrick() []*domain.NapTrickCard
