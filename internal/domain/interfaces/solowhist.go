...
// SoloWhistGame ソロ・ホイストのゲームインタフェース
type SoloWhistGame interface {
	BaseGame
	// Reset ゲームを初期化する
	Reset()
	...
	PlayerBid(bid domain.SoloWhistBid) error
	...
	SetConfig(cfg domain.SoloWhistConfig)

	// GetGameEndFlag ゲーム終了フラグを取得する
	GetGameEndFlag() bool
	// GetPhase 現在のフェーズを取得する
	GetPhase() domain.SoloWhistPhase
	...
	GetCurrentTrick() []*domain.SoloWhistTrickCard
