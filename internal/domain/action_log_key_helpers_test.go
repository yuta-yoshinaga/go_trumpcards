...
func TestActionLogKeyHelpersCoverEveryBranch(t *testing.T) {
	tests := []struct {
		...
		{"ombre sacar", ombreOutcomeKey(OmbreOutcomeSacar), "ombre.outcomeShort.sacar"},
		{"ombre puesta", ombreOutcomeKey(OmbreOutcomePuesta), "ombre.outcomeShort.puesta"},
		{"ombre codille", ombreOutcomeKey(OmbreOutcomeCodille), "ombre.outcomeShort.codille"},
		...
		{"quadrille sacar", quadrilleOutcomeKey(QuadrilleOutcomeSacar), "quadrille.outcomeShort.sacar"},
		{"quadrille puesta", quadrilleOutcomeKey(QuadrilleOutcomePuesta), "quadrille.outcomeShort.puesta"},
		{"quadrille codille", quadrilleOutcomeKey(QuadrilleOutcomeCodille), "quadrille.outcomeShort.codille"},
