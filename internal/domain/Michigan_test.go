...
func TestMichigan_UnmarshalValidation(t *testing.T) {
	...
	cases := map[string]string{
		...
		"boodle bad suit":  `{` + base + `,"ph":0,"rn":1,"bd":[{"c":{"d":9,"v":1}},{"c":{"d":2,"v":13}},{"c":{"d":3,"v":12}},{"c":{"d":4,"v":11}}]}`,
		"boodle bad value": `{` + base + `,"ph":0,"rn":1,"bd":[{"c":{"d":1,"v":0}},{"c":{"d":2,"v":13}},{"c":{"d":3,"v":12}},{"c":{"d":4,"v":11}}]}`,
		"dead hand bad":    `{` + base + `,"ph":0,"rn":1,"dh":[{"d":9,"v":1}]}`,
		"round chips len":  `{` + base + `,"ph":0,"rn":1,"rs":[1,2]}`,
		"round chips neg":  `{` + base + `,"ph":0,"rn":1,"rs":[-1,1,1]}`,
	}
