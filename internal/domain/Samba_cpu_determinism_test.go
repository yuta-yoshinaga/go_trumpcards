...
func TestSambaCPUFindMeldsDeterministicRankOrder(t *testing.T) {
	p := NewSambaPlayer(false, 0)
...
func TestSambaCPUFindSequenceMeldsDeterministicSuitOrder(t *testing.T) {
	p := NewSambaPlayer(false, 0)
