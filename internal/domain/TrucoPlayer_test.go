...
func TestTrucoPlayerResetGame(t *testing.T) {
	p := NewTrucoPlayer(true)
...
func TestTrucoPlayerJSONRoundTrip(t *testing.T) {
	p := NewTrucoPlayer(false)
...
func TestTrucoPlayerUnmarshalNilGamePlayer(t *testing.T) {
	var got TrucoPlayer
