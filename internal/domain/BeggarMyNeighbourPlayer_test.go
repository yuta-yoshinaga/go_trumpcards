...
func TestNewBeggarMyNeighbourPlayer(t *testing.T) {
	p := NewBeggarMyNeighbourPlayer(true)
...
func TestBeggarMyNeighbourPlayer_AddAndDraw(t *testing.T) {
	p := NewBeggarMyNeighbourPlayer(false)
...
func TestBeggarMyNeighbourPlayer_RefillFromDiscard(t *testing.T) {
	p := NewBeggarMyNeighbourPlayer(false)
	c1 := NewCard(CardDesignSpade, 5, false)
	c2 := NewCard(CardDesignHeart, 7, false)
...
func TestBeggarMyNeighbourPlayer_ResetPiles(t *testing.T) {
	p := NewBeggarMyNeighbourPlayer(false)
...
func TestBeggarMyNeighbourPlayer_JSON(t *testing.T) {
	p := NewBeggarMyNeighbourPlayer(true)
	...
	var decoded BeggarMyNeighbourPlayer
