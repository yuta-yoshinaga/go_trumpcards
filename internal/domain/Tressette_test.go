...
func trResolve(g *domain.Tressette, trickNum int, trick []*domain.TressetteTrickCard) {
...
func TestTressetteTrickWinnerHighestStrength(t *testing.T) {
	...
	trResolve(g, 1, []*domain.TressetteTrickCard{
...
func TestTressetteUltimaBonus(t *testing.T) {
	g := newTestTressette()
	trResolve(g, 10, []*domain.TressetteTrickCard{
...
func TestTressetteResolveTrickGuards(t *testing.T) {
	...
	g.SetCurrentTrick([]*domain.TressetteTrickCard{{PlayerIdx: 0, Card: trCard(domain.CardDesignSpade, 3)}})
	g.ResolveTrick()
...
func TestTressettePlayerPlayMustFollow(t *testing.T) {
	...
	g.SetCurrentTrick([]*domain.TressetteTrickCard{{PlayerIdx: 3, Card: trCard(domain.CardDesignSpade, 4)}})
...
func TestTressettePlayCompletesTrick(t *testing.T) {
	...
	g.SetCurrentTrick([]*domain.TressetteTrickCard{
...
func TestTressetteCpuPlayFollowsAndWins(t *testing.T) {
	...
	g.SetCurrentTrick([]*domain.TressetteTrickCard{{PlayerIdx: 0, Card: trCard(domain.CardDesignSpade, 1)}})
	g.CpuPlay()
...
func TestTressetteHintFollowReasons(t *testing.T) {
	...
	g.SetCurrentTrick([]*domain.TressetteTrickCard{{PlayerIdx: 2, Card: trCard(domain.CardDesignSpade, 3)}})
