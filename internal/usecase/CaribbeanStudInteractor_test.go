...
func TestNewCaribbeanStudInteractor(t *testing.T) {
	mockGame := new(interfaces.MockCaribbeanStudGame)
	mockPresenter := new(presenter.MockCaribbeanStudPresenter)
	ci := NewCaribbeanStudInteractor(mockGame, mockPresenter)
	assert.NotNil(t, ci)
}

func TestNewCaribbeanStudInteractor_NilPanics(t *testing.T) {
	mockPresenter := new(presenter.MockCaribbeanStudPresenter)
	assert.Panics(t, func() { NewCaribbeanStudInteractor(nil, mockPresenter) })

	mockGame := new(interfaces.MockCaribbeanStudGame)
	assert.Panics(t, func() { NewCaribbeanStudInteractor(mockGame, nil) })
}

func TestCaribbeanStudInteractor_Reset(t *testing.T) {
	mockGame := new(interfaces.MockCaribbeanStudGame)
	mockPresenter := new(presenter.MockCaribbeanStudPresenter)
	ci := NewCaribbeanStudInteractor(mockGame, mockPresenter)
...
func TestCaribbeanStudInteractor_Bet(t *testing.T) {
...
func TestCaribbeanStudInteractor_Play(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		mockGame := new(interfaces.MockCaribbeanStudGame)
		mockPresenter := new(presenter.MockCaribbeanStudPresenter)
		ci := NewCaribbeanStudInteractor(mockGame, mockPresenter)
...
func TestCaribbeanStudInteractor_Fold(t *testing.T) {
	mockGame := new(interfaces.MockCaribbeanStudGame)
	mockPresenter := new(presenter.MockCaribbeanStudPresenter)
	ci := NewCaribbeanStudInteractor(mockGame, mockPresenter)
...
func TestCaribbeanStudInteractor_ActionLog(t *testing.T) {
	mockGame := new(interfaces.MockCaribbeanStudGame)
	mockPresenter := new(presenter.MockCaribbeanStudPresenter)
	ci := NewCaribbeanStudInteractor(mockGame, mockPresenter)
