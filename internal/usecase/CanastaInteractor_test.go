...
func TestNewCanastaInteractor_NilGuards(t *testing.T) {
	pMock := new(presenter.MockCanastaPresenter)

	t.Run("panics when g is nil", func(t *testing.T) {
		assert.PanicsWithValue(t, "CanastaInteractor: g must not be nil", func() {
			usecase.NewCanastaInteractor(nil, pMock)
		})
	})

	t.Run("panics when gp is nil", func(t *testing.T) {
		gameMock := new(interfaces.MockCanastaGame)
		assert.PanicsWithValue(t, "CanastaInteractor: gp must not be nil", func() {
			usecase.NewCanastaInteractor(gameMock, nil)
		})
	})
}

func TestCanastaInteractor_Reset(t *testing.T) {
	mockOutput := `{"phase":0}`
	...
	t.Run("reset calls game Reset and returns output", func(t *testing.T) {
		...
		gameMock.On("GetPhase").Return(domain.CanastaPhaseDraw)
...
func TestCanastaInteractor_ResetWithConfig(t *testing.T) {
	mockOutput := `{"phase":0}`
	...
	t.Run("valid config sets config then resets", func(t *testing.T) {
		...
		pMock.On("Output", mock.Anything, mock.Anything).Return(mockOutput)
		gameMock := new(interfaces.MockCanastaGame)
		cfg := domain.CanastaConfig{CpuDifficulty: domain.CanastaCpuDifficultyHard, PointLimit: 5000}
	...
	t.Run("invalid config returns error without resetting", func(t *testing.T) {
		...
		ci := usecase.NewCanastaInteractor(gameMock, pMock)
		cfg := domain.CanastaConfig{CpuDifficulty: domain.CanastaCpuDifficulty(-1), PointLimit: 100}
		result := ci.ResetWithConfig(cfg)
...
func TestCanastaInteractor_DrawFromStock(t *testing.T) {
	mockOutput := `{"phase":0}`
...
func TestCanastaInteractor_DrawFromDiscard(t *testing.T) {
	mockOutput := `{"phase":0}`
...
func TestCanastaInteractor_Meld(t *testing.T) {
	mockOutput := `{"phase":0}`
	...
	t.Run("valid meld runs CPU turns", func(t *testing.T) {
		...
		gameMock.On("GetPhase").Return(domain.CanastaPhaseMeld)
		gameMock.On("IsHumanTurn").Return(true)
...
func TestCanastaInteractor_SkipMeld(t *testing.T) {
	mockOutput := `{"phase":0}`
...
func TestCanastaInteractor_Discard(t *testing.T) {
	mockOutput := `{"phase":0}`
	...
	t.Run("valid discard runs CPU turns", func(t *testing.T) {
		...
		gameMock.On("GetPhase").Return(domain.CanastaPhaseDiscard)
		gameMock.On("IsHumanTurn").Return(true)
...
func TestCanastaInteractor_GoOut(t *testing.T) {
	mockOutput := `{"phase":0}`
...
func TestCanastaInteractor_NextRound(t *testing.T) {
	mockOutput := `{"phase":0}`
...
func TestCanastaInteractor_GetConfig(t *testing.T) {
	t.Run("returns config from game", func(t *testing.T) {
		pMock := new(presenter.MockCanastaPresenter)
		gameMock := new(interfaces.MockCanastaGame)
		expected := domain.CanastaConfig{CpuDifficulty: domain.CanastaCpuDifficultyHard, PointLimit: 5000}
...
func TestCanastaInteractor_ActionLog(t *testing.T) {
	pMock := new(presenter.MockCanastaPresenter)
	gameMock := new(interfaces.MockCanastaGame)
...
func TestCanastaInteractor_RunCpuTurns(t *testing.T) {
	...
	t.Run("stops when phase is RoundEnd", func(t *testing.T) {
		...
		gameMock.On("Reset").Return()
		gameMock.On("GetGameEndFlag").Return(false)
		gameMock.On("GetPhase").Return(domain.CanastaPhaseRoundEnd)
	...
	t.Run("stops when phase is GameEnd", func(t *testing.T) {
		...
		gameMock.On("Reset").Return()
		gameMock.On("GetGameEndFlag").Return(false)
		gameMock.On("GetPhase").Return(domain.CanastaPhaseGameEnd)
