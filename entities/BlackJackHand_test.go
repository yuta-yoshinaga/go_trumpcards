...
func TestBlackJackHand_Score(t *testing.T) {
	t.Run("score with ace as 11", func(t *testing.T) {
		h := entities.NewBlackJackHand()
		h.AddCard(entities.NewCard(entities.CardDesignSpade, 1, false))
		h.AddCard(entities.NewCard(entities.CardDesignHeart, 9, false))
	...
	t.Run("score with ace as 1", func(t *testing.T) {
		...
		h.AddCard(entities.NewCard(entities.CardDesignSpade, 1, false))
		h.AddCard(entities.NewCard(entities.CardDesignHeart, 9, false))
		h.AddCard(entities.NewCard(entities.CardDesignClover, 5, false))
		assert.Equal(t, 15, h.GetScore())
	})
	t.Run("score with face cards as 10", func(t *testing.T) {
		h := entities.NewBlackJackHand()
		h.AddCard(entities.NewCard(entities.CardDesignSpade, 11, false))
		h.AddCard(entities.NewCard(entities.CardDesignHeart, 12, false))
		assert.Equal(t, 20, h.GetScore())
	})
	t.Run("score with two aces", func(t *testing.T) {
		h := entities.NewBlackJackHand()
		h.AddCard(entities.NewCard(entities.CardDesignSpade, 1, false))
		h.AddCard(entities.NewCard(entities.CardDesignHeart, 1, false))
...
func TestBlackJackHand_IsBlackJack(t *testing.T) {
	t.Run("natural blackjack ace+10", func(t *testing.T) {
		h := entities.NewBlackJackHand()
		h.AddCard(entities.NewCard(entities.CardDesignSpade, 1, false))
		h.AddCard(entities.NewCard(entities.CardDesignHeart, 10, false))
		assert.True(t, h.IsBlackJack())
	})
	t.Run("natural blackjack ace+king", func(t *testing.T) {
		h := entities.NewBlackJackHand()
		h.AddCard(entities.NewCard(entities.CardDesignSpade, 1, false))
		h.AddCard(entities.NewCard(entities.CardDesignHeart, 13, false))
		assert.True(t, h.IsBlackJack())
	})
	t.Run("not blackjack with 3 cards", func(t *testing.T) {
		h := entities.NewBlackJackHand()
		h.AddCard(entities.NewCard(entities.CardDesignSpade, 7, false))
		h.AddCard(entities.NewCard(entities.CardDesignHeart, 7, false))
		h.AddCard(entities.NewCard(entities.CardDesignClover, 7, false))
		assert.False(t, h.IsBlackJack())
	})
	t.Run("not blackjack score not 21", func(t *testing.T) {
		h := entities.NewBlackJackHand()
		h.AddCard(entities.NewCard(entities.CardDesignSpade, 5, false))
		h.AddCard(entities.NewCard(entities.CardDesignHeart, 10, false))
		assert.False(t, h.IsBlackJack())
	})
}
...
func TestBlackJackHand_CanSplit(t *testing.T) {
	t.Run("can split same value", func(t *testing.T) {
		h := entities.NewBlackJackHand()
		h.AddCard(entities.NewCard(entities.CardDesignSpade, 8, false))
		h.AddCard(entities.NewCard(entities.CardDesignHeart, 8, false))
		assert.True(t, h.CanSplit())
	})
	t.Run("can split face cards king+queen", func(t *testing.T) {
		h := entities.NewBlackJackHand()
		h.AddCard(entities.NewCard(entities.CardDesignSpade, 13, false))
		h.AddCard(entities.NewCard(entities.CardDesignHeart, 12, false))
		assert.True(t, h.CanSplit())
	})
	...
	t.Run("cannot split with 3 cards", func(t *testing.T) {
		h := entities.NewBlackJackHand()
		h.AddCard(entities.NewCard(entities.CardDesignSpade, 5, false))
		h.AddCard(entities.NewCard(entities.CardDesignHeart, 5, false))
		h.AddCard(entities.NewCard(entities.CardDesignClover, 5, false))
		assert.False(t, h.CanSplit())
	})
