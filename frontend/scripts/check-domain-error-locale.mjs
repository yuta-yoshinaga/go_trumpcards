...
// 内訳: 素のリテラル 164 / fmt.Sprintf 12 / 複数行 0. (実測)
const JAPANESE_LITERAL_CEILING = 176;
// floor.mjs の指針どおり現在値の約 2/3 (231 × 2/3 ≈ 154)。天井が下がり続けるため、floor も追随して下げる。
const JAPANESE_LITERAL_FLOOR = 154;
