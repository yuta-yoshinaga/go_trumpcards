...
// 内訳: 素のリテラル 138 / fmt.Sprintf 10 / 複数行 0. (実測)
const JAPANESE_LITERAL_CEILING = 148;
// floor.mjs の指針どおり現在値の約 2/3 (148 × 2/3 ≈ 98)。天井が下がり続けるため、floor も追随して下げる。
const JAPANESE_LITERAL_FLOOR = 98;
