...
// 内訳: 素のリテラル 88 / fmt.Sprintf 1 / 複数行 0. (実測)
const JAPANESE_LITERAL_CEILING = 89;
// floor.mjs の指針どおり現在値の約 2/3 (94 × 2/3 ≈ 63)。天井が下がり続けるため、floor も追随して下げる。
const JAPANESE_LITERAL_FLOOR = 63;
