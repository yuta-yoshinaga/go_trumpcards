...
// 内訳: 素のリテラル 26 / fmt.Sprintf 0 / 複数行 0. (実測)
const JAPANESE_LITERAL_CEILING = 26;
// floor.mjs の指針どおり現在値の約 2/3 (26 × 2/3 ≈ 17)。天井が下がり続けるため、floor も追随して下げる。
const JAPANESE_LITERAL_FLOOR = 17;
