...
// 内訳: 素のリテラル 233 / fmt.Sprintf 25 / 複数行 0. (実測)
const JAPANESE_LITERAL_CEILING = 258;
// floor.mjs の指針どおり現在値の約 2/3 (345 × 2/3 ≈ 230)。天井が下がり続けるため、floor も追随して下げる。
const JAPANESE_LITERAL_FLOOR = 230;
