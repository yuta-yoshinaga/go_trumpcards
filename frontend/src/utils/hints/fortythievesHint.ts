...
/**
 * Returns a frontend {@link HintResult} for FortyThieves, or null when no suggestion is
 * available.
 *
 ...
 */
export function getFortyThievesHint(state: FortyThievesResponse): HintResult | null {
  ...
  return { targetAction: target, reason: 'frontendHint.fortythievesMove', confidence: 'moderate' };
}
