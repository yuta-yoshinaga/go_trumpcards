...
/**
 * Returns a frontend {@link HintResult} for Schafkopf, or null when no
 * suggestion is available.
 *
 * Unlike most games, Schafkopf's hint is computed entirely by the Go backend
 ...
 */
export function getSchafkopfHint(state: SchafkopfResponse): HintResult | null {
