...
/** Returns a Matrimony frontend hint or null.
 *
...
export function getMatrimonyHint(state: MatrimonyResponse): HintResult | null {
  if (state.phase !== MatrimonyPhase.PLAYING) return null;
