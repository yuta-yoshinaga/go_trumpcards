 ...
 * `RankAndFile.go`: the eight foundation piles are NOT locked to a suit by
 ...
 */
export function rankAndFileFoundationTarget(card: Card, foundation: Card[][]): RankAndFileMoveZone | null {
