...
export interface CitadelLegalTargets {
 ...
 *
 * Sync: `Citadel.canPlaceOnTableau` / `canPlaceOnFoundation`.
 *
 ...
 */
export function citadelLegalTargets(
  tableau: CitadelTableauCard[][],
  foundation: Card[][],
  card: Card | null | undefined,
): CitadelLegalTargets {
  const result: CitadelLegalTargets = { tableau: new Set(), foundation: new Set() };
