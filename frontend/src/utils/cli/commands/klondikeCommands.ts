...
type KlondikeArgs = Parameters<typeof klondikeApi.exec>;
...
/** Parse a Klondike CLI command into API exec arguments. */
export function parseKlondikeCommand(input: string): CliParseResult<KlondikeArgs> {
...
function parseMoveCommand(args: string[]): CliParseResult<KlondikeArgs> {
...
/** Help text for Klondike CLI mode. */
export const KLONDIKE_HELP: string[] = [
