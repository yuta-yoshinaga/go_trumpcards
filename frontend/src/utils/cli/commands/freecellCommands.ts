...
type FreeCellArgs = Parameters<typeof freecellApi.exec>;
...
export function parseFreecellCommand(input: string): CliParseResult<FreeCellArgs> {
...
function parseMoveCommand(args: string[]): CliParseResult<FreeCellArgs> {
...
/** Help text for FreeCell CLI mode. */
export const FREECELL_HELP: string[] = [
