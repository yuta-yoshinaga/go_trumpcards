...
type SambaArgs = Parameters<typeof sambaApi.exec>;
...
/** Parse a Samba CLI command into API exec arguments. */
export function parseSambaCommand(input: string): CliParseResult<SambaArgs> {
...
/** Help text for Samba CLI mode. */
export const SAMBA_HELP: string[] = [
