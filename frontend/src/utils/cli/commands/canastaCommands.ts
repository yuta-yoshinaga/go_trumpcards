...
type CanastaArgs = Parameters<typeof canastaApi.exec>;
...
export function parseCanastaCommand(input: string): CliParseResult<CanastaArgs> {
...
/** Help text for Canasta CLI mode. */
export const CANASTA_HELP: string[] = [
