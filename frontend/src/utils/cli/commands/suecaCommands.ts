...
type SuecaArgs = Parameters<typeof suecaApi.exec>;

const VALID_COMMANDS = ['p', 'play', 'n', 'next', 'nr', 'nextround', 'h', 'hint', 'r', 'reset', 'help', '?'];

/** Parse a Sueca CLI command into API exec arguments. */
export function parseSuecaCommand(input: string): CliParseResult<SuecaArgs> {
...
/** Help text for Sueca CLI mode. */
export const SUECA_HELP: string[] = [
