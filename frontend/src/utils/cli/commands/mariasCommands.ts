...
type MariasArgs = Parameters<typeof mariasApi.exec>;

const VALID_COMMANDS = ['p', 'play', 'n', 'next', 'nr', 'nextround', 'h', 'hint', 'r', 'reset', 'help', '?'];

/** Parse a Mariáš CLI command into API exec arguments. */
export function parseMariasCommand(input: string): CliParseResult<MariasArgs> {
...
/** Help text for Mariáš CLI mode. */
export const MARIAS_HELP: string[] = [
