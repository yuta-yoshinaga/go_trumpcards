...
type OmbreArgs = Parameters<typeof ombreApi.exec>;
...
/** Parse an Ombre (Hombre) CLI command into API exec arguments. */
export function parseOmbreCommand(input: string): CliParseResult<OmbreArgs> {
...
/** Help text for Ombre (Hombre) CLI mode. */
export const OMBRE_HELP: string[] = [
