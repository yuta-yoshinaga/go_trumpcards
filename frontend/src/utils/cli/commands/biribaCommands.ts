...
type BiribaArgs = Parameters<typeof biribaApi.exec>;
...
/** Parse a Biriba CLI command into API exec arguments. */
export function parseBiribaCommand(input: string): CliParseResult<BiribaArgs> {
...
/** Help text for Biriba CLI mode. */
export const BIRIBA_HELP: string[] = [
  'ds/drawstock   - Draw from stock',
  'dd/drawdiscard - Draw from discard',
  'meld 0,1,2      - Meld a same-suit sequence',
  'sm/skipmeld    - Skip meld phase',
  'dis 0          - Discard a card',
  'go/goout       - Go out',
