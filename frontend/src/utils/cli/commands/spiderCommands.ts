...
type SpiderArgs = Parameters<typeof spiderApi.exec>;
...
export function parseSpiderCommand(input: string): CliParseResult<SpiderArgs> {
...
/** Help text for Spider Solitaire CLI mode. */
export const SPIDER_HELP: string[] = [
  'd/deal      - Deal new row',
