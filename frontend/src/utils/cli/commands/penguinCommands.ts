import type { penguinApi } from '../../../api/gameApi';
import { parseIntArg, splitCommand, suggestCommand } from '../commandParserBase';
import type { CliParseResult } from '../types';

type PenguinArgs = Parameters<typeof penguinApi.exec>;
...
/** Parse a Penguin CLI command into API exec arguments. */
export function parsePenguinCommand(input: string): CliParseResult<PenguinArgs> {
...
function parseMoveCommand(args: string[]): CliParseResult<PenguinArgs> {
