...
type GinRummyArgs = Parameters<typeof ginrummyApi.exec>;
...
export function parseGinrummyCommand(input: string): CliParseResult<GinRummyArgs> {
...
/** Help text for Gin Rummy CLI mode. */
export const GINRUMMY_HELP: string[] = [
