...
/** Format a Baker's Dozen game state as terminal text. */
export function formatBakersDozenState(state: BakersDozenResponse): string {
  const lines: string[] = [];

  lines.push(formatHeader("Baker's Dozen"));
