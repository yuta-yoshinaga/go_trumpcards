...
/** Format a Twenty-Nine (29) game state as terminal text. */
export function formatTwentyNineState(state: TwentyNineResponse): string {
  const lines: string[] = [];

  lines.push(formatHeader('Twenty-Nine (29)'));
  lines.push(
