...
function makeState(overrides?: Partial<HeartsResponse>): HeartsResponse {
  return {
    players: [
      ...
      { id: 1, isHuman: false, cardCount: 13, cards: [], bid: 0, roundScore: 0, cumulativeScore: 0, trickCount: 0 },
      { id: 2, isHuman: false, cardCount: 13, cards: [], bid: 0, roundScore: 0, cumulativeScore: 0, trickCount: 0 },
      { id: 3, isHuman: false, cardCount: 13, cards: [], bid: 0, roundScore: 0, cumulativeScore: 0, trickCount: 0 },
    ],
    phase: 1,
    roundNumber: 1,
    trickNumber: 1,
