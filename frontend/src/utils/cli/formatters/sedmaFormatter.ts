...
/** Format a Sedma game state as terminal text. No trump display — Sedma has no trump. */
export function formatSedmaState(state: SedmaResponse): string {
  const lines: string[] = [];

  lines.push(formatHeader('Sedma'));
  lines.push(
