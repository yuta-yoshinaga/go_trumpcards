...
/** Format a WillOTheWisp game state as terminal text. */
export function formatWillOTheWispState(state: WillOTheWispResponse): string {
  const lines: string[] = [];

  lines.push(formatHeader("Will o' the Wisp"));
