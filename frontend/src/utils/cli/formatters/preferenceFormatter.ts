...
/** Format a Préférence game state as terminal text. */
export function formatPreferenceState(state: PreferenceResponse): string {
  const lines: string[] = [];

  lines.push(formatHeader('Préférence'));
  lines.push(
