...
/** Format a Catch the Ten game state as terminal text. */
export function formatCatchTenState(state: CatchTenResponse): string {
  const lines: string[] = [];

  lines.push(formatHeader('Catch the Ten'));
