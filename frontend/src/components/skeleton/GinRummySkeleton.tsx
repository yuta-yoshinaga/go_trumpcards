...
/** Renders a loading skeleton placeholder for the Gin Rummy page. */
export function GinRummySkeleton() {
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 bg-game-bg-blue" aria-busy="true" data-testid="skeleton">
      ...
      <GameFooter className="bg-game-bg-blue-dark border-white/20 px-4 py-2.5">
        <SkeletonHand cardWidth={cardWidth} cardHeight={cardHeight} count={10} className="mb-2" />
