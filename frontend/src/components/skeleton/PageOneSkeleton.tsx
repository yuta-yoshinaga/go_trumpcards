...
/** Renders a loading skeleton placeholder for the Page One page. */
export function PageOneSkeleton() {
  const { cardWidth, cardHeight } = useCardDimensions();
  return (
    <GameSkeleton
      bgClass={gameTheme.pageone.bg}
      footerClassName={`${gameTheme.pageone.footer} px-4 py-2.5`}
      footer={
        <>
