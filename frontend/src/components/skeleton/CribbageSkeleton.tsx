...
/** Renders a loading skeleton placeholder for the Cribbage page. */
export function CribbageSkeleton() {
  ...
  return (
    <GameSkeleton
      ...
      footer={
        <>
          <SkeletonHand cardWidth={cardWidth} cardHeight={cardHeight} count={6} className="mb-2" />
