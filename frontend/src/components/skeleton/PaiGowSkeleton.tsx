...
/** Renders a loading skeleton placeholder for the Pai Gow Poker page. */
export function PaiGowSkeleton() {
      ...
      {Array.from({ length: 2 }, (_, i) => (
        <div key={i} className="mb-4">
          ...
          <div className="flex justify-center gap-2">
            <SkeletonHand cardWidth={cardWidth} cardHeight={cardHeight} count={7} />
          </div>
        </div>
      ))}
    </GameSkeleton>
