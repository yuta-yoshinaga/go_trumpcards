    ...
    >
      ...
      {onRetry && (
        <button
          type="button"
          onClick={onRetry}
          className="px-3 py-1 text-xs font-medium bg-white/20 hover:bg-white/30 rounded transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/80 min-h-[44px] inline-flex items-center"
        >
          {t('button.retry')}
        </button>
      )}
