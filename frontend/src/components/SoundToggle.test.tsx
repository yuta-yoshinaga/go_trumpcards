...
describe('SoundToggle', () => {
  it('renders mute label when unmuted', () => {
    vi.mocked(useSound).mockReturnValue({ muted: false, toggleMute: mockToggleMute, playSound: vi.fn() });
    render(<SoundToggle />);
  ...
  it('renders unmute label when muted', () => {
    vi.mocked(useSound).mockReturnValue({ muted: true, toggleMute: mockToggleMute, playSound: vi.fn() });
    render(<SoundToggle />);
