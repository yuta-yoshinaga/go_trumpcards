...
import { getTongitsHint } from '../utils/hints/tongitsHint';
...
export const hintFactories = {
  ...
  courchevelhilo: (s) => getOmahaHiLoHint(s as OmahaResponse),
  ...
  chicago: (s) => getSevenCardStudHint(s as SevenCardStudResponse),
  ...
  tongits: (s) => getTongitsHint(s as TongitsResponse),
