...
export const gameCategories: readonly GameCategory[] = [
  {
    ...
    routes: [
      ...
      },
      {
        ...
        icon: '🐎',
        page: 'Horse',
        profile: { mood: [3, 2, 4, 3], skill: [5, 5, 5, 2], social: [3, 4, 4, 5, 2], theme: [1, 5, 1, 1, 1, 1] },
      },
      {
        path: '/sakura',
        labelKey: 'nav.sakura',
      ...
      {
        path: '/botifarra',
        labelKey: 'nav.botifarra',
        icon: '🇪🇸',
        page: 'Botifarra',
        profile: { mood: [2, 3, 4, 2], skill: [2, 4, 5, 2], social: [5, 2, 5, 2, 3], theme: [2, 1, 1, 5, 2, 3] },
      },
      {
        path: '/rikken',
        labelKey: 'nav.rikken',
      ...
      },
      {
        ...
        icon: '🃏',
        page: 'CrazyFourPoker',
        profile: { mood: [4, 3, 3, 2], skill: [3, 4, 3, 3], social: [5, 3, 2, 3, 3], theme: [5, 1, 1, 1, 3, 1] },
      },
      {
        path: '/doubleattack',
        labelKey: 'nav.doubleattack',
        icon: '⚔️',
        page: 'DoubleAttack',
  ...
  },
  {
    ...
    routes: [
      ...
      {
        path: '/courchevelhilo',
        labelKey: 'nav.courchevelhilo',
        icon: '⛄',
        page: 'CourchevelHiLo',
        profile: { mood: [1, 2, 5, 1], skill: [0, 3, 5, 0], social: [1, 3, 5, 1, 4], theme: [3, 1, 3, 1, 3, 1] },
      },
      {
        path: '/shortdeck',
  ...
  },
  {
    ...
    routes: [
      ...
      {
        path: '/germansolo',
        labelKey: 'nav.germansolo',
        icon: '🇩🇪',
        page: 'GermanSolo',
        profile: { mood: [2, 3, 5, 2], skill: [3, 4, 5, 2], social: [1, 4, 5, 3, 5], theme: [2, 4, 2, 1, 2, 3] },
      },
      {
        path: '/gleek',
        labelKey: 'nav.gleek',
        icon: '🏴󠁧󠁢󠁥󠁮󠁧󠁿',
        page: 'Gleek',
        profile: { mood: [2, 3, 5, 2], skill: [3, 5, 5, 2], social: [1, 4, 5, 3, 5], theme: [2, 4, 2, 1, 2, 3] },
      },
      {
        path: '/ulti',
        labelKey: 'nav.ulti',
      ...
      },
      {
        ...
        icon: '🔭',
        // Tarocchini / Scarto の隣。同じイタリア系タロットで、親が余剰札を捨てる
        // 骨格も共通なので、探す人は同じ列を見る。
        page: 'Minchiate',
      ...
      {
        path: '/coinche',
        labelKey: 'nav.coinche',
        icon: '🇫🇷',
        page: 'Coinche',
        profile: { mood: [2, 4, 4, 2], skill: [4, 5, 3, 2], social: [1, 3, 5, 3, 4], theme: [2, 5, 1, 1, 2, 3] },
      },
      {
        path: '/belote',
        labelKey: 'nav.belote',
      ...
      {
        path: '/schafkopf',
        labelKey: 'nav.schafkopf',
        icon: '🍺',
        page: 'Schafkopf',
        profile: { mood: [2, 4, 4, 3], skill: [5, 5, 2, 3], social: [1, 3, 5, 4, 3], theme: [2, 4, 1, 1, 2, 3] },
      },
      {
        path: '/julepe',
        labelKey: 'nav.julepe',
        icon: '🇪🇸',
        page: 'Julepe',
        profile: { mood: [4, 3, 3, 4], skill: [3, 3, 4, 3], social: [1, 4, 4, 3, 4], theme: [2, 2, 3, 2, 3, 4] },
      },
      {
        path: '/tarabish',
      ...
      {
        path: '/lingerlonger',
        labelKey: 'nav.lingerlonger',
        icon: '🪺',
        page: 'LingerLonger',
        profile: { mood: [2, 4, 4, 3], skill: [3, 3, 4, 3], social: [1, 3, 4, 4, 3], theme: [2, 4, 1, 1, 2, 3] },
      },
      {
        path: '/pig',
        labelKey: 'nav.pig',
      ...
      },
      {
        ...
        icon: '👏',
        page: 'Snap',
        profile: { mood: [4, 2, 3, 4], skill: [1, 1, 5, 2], social: [1, 3, 4, 4, 3], theme: [3, 2, 1, 1, 3, 3] },
      },
      {
        path: '/pasur',
        labelKey: 'nav.pasur',
        icon: '🎣',
        page: 'Pasur',
        profile: { mood: [3, 3, 4, 3], skill: [3, 5, 2, 3], social: [1, 3, 4, 4, 3], theme: [3, 2, 1, 1, 3, 3] },
      },
      {
        path: '/minibridge',
        labelKey: 'nav.minibridge',
        icon: '🎓',
        page: 'Minibridge',
        profile: { mood: [3, 4, 3, 3], skill: [3, 4, 3, 3], social: [1, 2, 5, 4, 3], theme: [2, 4, 1, 1, 2, 3] },
      },
      {
        path: '/honeymoonbridge',
        labelKey: 'nav.honeymoonbridge',
        icon: '💍',
        page: 'HoneymoonBridge',
        profile: { mood: [2, 4, 4, 3], skill: [5, 4, 2, 4], social: [5, 1, 1, 1, 1], theme: [2, 4, 1, 1, 2, 3] },
      },
      {
        path: '/sergeantmajor',
      ...
      },
      {
        ...
        icon: '🏛️',
        page: 'Hokm',
        profile: { mood: [2, 4, 5, 3], skill: [4, 4, 3, 3], social: [1, 2, 5, 4, 3], theme: [2, 4, 1, 1, 2, 3] },
      },
      {
        path: '/israeliwhist',
        labelKey: 'nav.israeliwhist',
        icon: '🕎',
        page: 'IsraeliWhist',
        profile: { mood: [2, 4, 4, 3], skill: [5, 5, 2, 3], social: [1, 3, 4, 4, 3], theme: [2, 4, 1, 1, 2, 3] },
      },
      {
        path: '/estimation',
  ...
  },
  {
    ...
    routes: [
      ...
      },
      {
        ...
        icon: '🧹',
        page: 'MrsMop',
        profile: { mood: [5, 1, 5, 2], skill: [4, 4, 5, 2], social: [5, 1, 0, 2, 4], theme: [3, 3, 2, 1, 2, 3] },
      },
      {
        path: '/narcotic',
        labelKey: 'nav.narcotic',
        icon: '🔁',
        page: 'Narcotic',
        profile: { mood: [5, 1, 5, 2], skill: [2, 2, 5, 1], social: [5, 1, 0, 2, 4], theme: [3, 3, 3, 1, 2, 3] },
      },
      {
        path: '/fourteenout',
        labelKey: 'nav.fourteenout',
        icon: '🔢',
        page: 'FourteenOut',
        profile: { mood: [5, 1, 5, 2], skill: [2, 3, 5, 1], social: [5, 1, 0, 2, 4], theme: [3, 3, 3, 1, 2, 3] },
      },
      {
        path: '/perseverance',
        labelKey: 'nav.perseverance',
        icon: '🪨',
        page: 'Perseverance',
        profile: { mood: [5, 1, 5, 2], skill: [3, 4, 4, 2], social: [5, 1, 0, 2, 4], theme: [3, 3, 2, 1, 2, 3] },
      },
      ...
      },
      {
        ...
        icon: '🇷🇺',
        page: 'Vint',
        profile: { mood: [4, 4, 3, 4], skill: [4, 5, 4, 3], social: [4, 4, 3, 4, 4], theme: [3, 2, 2, 1, 4, 3] },
      },
      {
        path: '/bideuchre',
        labelKey: 'nav.bideuchre',
        icon: '🃏',
        page: 'BidEuchre',
        profile: { mood: [4, 4, 3, 4], skill: [3, 4, 4, 3], social: [3, 4, 3, 4, 4], theme: [3, 2, 3, 1, 3, 3] },
      },
      {
        path: '/sixbidsolo',
        labelKey: 'nav.sixbidsolo',
        icon: '🎰',
        page: 'SixBidSolo',
      ...
      {
        path: '/dehlapakad',
        labelKey: 'nav.dehlapakad',
        icon: '🔟',
        page: 'DehlaPakad',
        profile: { mood: [4, 4, 4, 4], skill: [3, 4, 4, 4], social: [4, 5, 3, 4, 3], theme: [2, 3, 3, 1, 2, 4] },
      },
      {
        path: '/sutda',
        labelKey: 'nav.sutda',
      ...
      },
      {
        ...
        icon: '🧧',
        page: 'Guandan',
        profile: { mood: [4, 5, 3, 3], skill: [4, 4, 4, 3], social: [2, 4, 4, 4, 3], theme: [2, 3, 2, 1, 2, 4] },
      },
      {
        path: '/literature',
      ...
      },
      {
        ...
        icon: '🎩',
        page: 'Boston',
        profile: { mood: [4, 4, 3, 4], skill: [4, 5, 4, 3], social: [3, 4, 2, 4, 4], theme: [3, 2, 2, 1, 4, 3] },
      },
      {
        path: '/kaiser',
        labelKey: 'nav.kaiser',
        icon: '👑',
        page: 'Kaiser',
        profile: { mood: [4, 4, 3, 4], skill: [4, 4, 4, 3], social: [4, 4, 3, 4, 4], theme: [3, 2, 2, 1, 4, 3] },
      },
      {
        path: '/klaberjass',
        labelKey: 'nav.klaberjass',
        icon: '🎴',
        page: 'Klaberjass',
        profile: { mood: [4, 4, 3, 4], skill: [4, 4, 4, 3], social: [2, 3, 2, 4, 4], theme: [3, 2, 2, 1, 4, 3] },
      },
      {
        path: '/kille',
        labelKey: 'nav.kille',
        icon: '🃏',
        page: 'Kille',
        profile: { mood: [4, 4, 3, 4], skill: [2, 3, 4, 3], social: [3, 4, 2, 4, 4], theme: [3, 2, 2, 1, 3, 3] },
      },
      {
        path: '/nainjaune',
      ...
      },
      {
        ...
        icon: '🔢',
        page: 'CribbageSquares',
        profile: { mood: [5, 1, 5, 2], skill: [2, 4, 4, 3], social: [5, 1, 0, 2, 4], theme: [1, 4, 3, 1, 1, 5] },
      },
      {
        path: '/diplomat',
        labelKey: 'nav.diplomat',
        icon: '🎩',
        page: 'Diplomat',
      ...
      },
      {
        ...
        icon: '🧵',
        page: 'CrazyQuilt',
        profile: { mood: [5, 1, 5, 2], skill: [2, 4, 5, 3], social: [5, 1, 0, 2, 4], theme: [1, 4, 3, 2, 2, 5] },
      },
      {
        path: '/sirtommy',
  ...
  },
  {
    ...
    routes: [
      ...
      },
      {
        ...
        icon: '🇮🇹',
        page: 'Trappola',
        profile: { mood: [3, 4, 4, 3], skill: [3, 5, 4, 3], social: [1, 3, 5, 5, 4], theme: [3, 1, 2, 2, 5, 3] },
      },
      {
        path: '/canasta',
