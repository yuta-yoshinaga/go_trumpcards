...
export const workerUrl: Record<string, string> = {
  ...
  guandan: WORKER_EXTRA7,
  aluette: WORKER_EXTRA2,
  shengji: WORKER_EXTRA4,
  sjavs: WORKER_EXTRA2,
  ...
  pitch: WORKER_EXTRA5,
  euchre: WORKER_EXTRA7,
  bridge: WORKER_EXTRA3,
  napoleon: WORKER_EXTRA5,
  ...
  memory: WORKER_SOLO,
  ginrummy: WORKER_EXTRA7,
  indianrummy: WORKER_EXTRA,
  marriage: WORKER_EXTRA6,
  ...
  reddog: WORKER_EXTRA7,
  casinowar: WORKER_EXTRA7,
  ...
  guts: WORKER_EXTRA7,
  seventwentyseven: WORKER_EXTRA7,
  ...
  gongzhu: WORKER_EXTRA7,
  bristol: WORKER_SOLO,
  bidwhist: WORKER_EXTRA7,
  easthaven: WORKER_SOLO,
  tichu: WORKER_EXTRA6,
  bourre: WORKER_EXTRA6,
  sheepshead: WORKER_EXTRA7,
