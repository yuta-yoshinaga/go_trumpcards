...
vi.mock('../api/gameApi', () => ({
  bigOHiLoApi: { exec: vi.fn() },
  actionLogApi: { bigohilo: vi.fn() },
}));
...
const mockExec = vi.mocked(bigOHiLoApi.exec);
...
describe('BigOHiLoPage', () => {
  ...
  it('handles action log visibility and API fetch', async () => {
    ...
    vi.mocked(actionLogApi.bigohilo).mockResolvedValueOnce({ entries: [] });
