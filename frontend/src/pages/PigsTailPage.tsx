...
import { usePigsTailGame } from '../hooks/usePigsTailGame';
...
function PigsTailPageContent() {
  ...
  const { state, loading, handleDraw, handleReset } = usePigsTailGame();
          ...
          {state.players.map((player, idx) => (
            <div
              ...
              className={`flex items-center justify-between px-3 py-2 rounded ${
                !isGameEnd && state.currentTurn === idx ? 'bg-yellow-600/30 border border-yellow-400/50' : 'bg-black/30'
