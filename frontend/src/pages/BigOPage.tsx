...
/** Renders the 5 Card Omaha (Big O) game page with community cards, betting,
 * and showdown. Big O is Omaha dealt 5 hole cards (still use exactly 2). */
...
function BigOPageContent() {
  ...
  const bigOResetConfig = useMemo(() => ({ bettingLimit }), [bettingLimit]);
  const {
    t,
    tc,
    actionLog,
