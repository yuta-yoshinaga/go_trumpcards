...
import { SirTommyPage, sirtommyNextRank } from './SirTommyPage';

vi.mock('../api/gameApi', () => ({
  sirtommyApi: { exec: vi.fn() },
  actionLogApi: { sirtommy: vi.fn() },
}));

const mockExec = vi.mocked(sirtommyApi.exec);

const card = (design: CardDesign, value: number): Card => ({ design, value });

const playingState: SirTommyResponse = {
  ...
  isStalemate: false,
  message: '',
  messageCode: 'sirtommy.playing',
};

const gameClearState: SirTommyResponse = {
  ...playingState,
  phase: 1,
  stockCount: 0,
  stockTop: undefined,
  moveCount: 100,
  messageCode: 'sirtommy.gameClear',
  messageParams: { moveCount: '100' },
};

const gameOverState: SirTommyResponse = {
  ...playingState,
  phase: 2,
  messageCode: 'sirtommy.gameOver',
};
