...
export function MemoryPage() {
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 bg-[#1a2c5c]" aria-busy={loading}>
      ...
      {/* Landscape orientation banner (visible on small portrait screens via CSS) */}
      <div className="memory-landscape-banner items-center gap-2 px-4 py-2 bg-yellow-500/90 text-black text-sm font-medium">
