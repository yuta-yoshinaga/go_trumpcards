...
- **Translation files**: `src/i18n/locales/{ja,en}/{common,blackjack,poker,oldmaid,daifugo,sevens,doubt,holdem,omaha,hearts,memory,klondike,freecell,baccarat,spades,crazyeights,ginrummy,spider,napoleon,indianpoker,videopoker,euchre,tutorial}.json`
...
- **Progress tracking**: `TutorialProgressPanel` in NavBar shows completion icons for all 21 games with a progress bar.
