...
test.describe('Catch the Ten (Scotch Whist) E2E', () => {
  test('loads, resets, and renders the trick-play UI', async ({ page }) => {
    await navigateTo(page, '/catchten');
    ...
    // Some interactive control must be present (the human's play control, a
    ...
    // Round info still renders after the game loop progresses.
