...
- **収まることが大きさより優先**: タップターゲットを大きくする・情報を足す等の変更がスクロールを生むなら改悪。小さくてもビューポートに収まりゲームが成立するならOK
