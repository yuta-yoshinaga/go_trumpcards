...
| **solo** | Solitaire & rummy | `cmd/workers/solo/main.go` | klondike, freecell, spider, spiderette, pyramid, tripeaks, memory, ginrummy, canasta, cribbage, golf, clocksolitaire, fortythieves, canfield, yukon, russiansolitaire, scorpion, accordion, pokersquares, crescent, bakersdozen, beleagueredcastle |
