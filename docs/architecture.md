...
| **classic** | Trick-taking & matching | `cmd/workers/classic/main.go` | hearts, spades, euchre, napoleon, mighty, oldmaid, doubt, daifugo, bigtwo, sevens, crazyeights, ohhell, bridge, speed, gofish, pinochle, pigtail, twotenjack, war, durak, fiftyone, whist, trash, spiteandmalice, skat, shithead, nertz, slapjack, belote |
| **solo** | Solitaire & rummy | `cmd/workers/solo/main.go` | klondike, freecell, cruel, spider, spiderette, pyramid, tripeaks, memory, ginrummy, canasta, cribbage, golf, clocksolitaire, fortythieves, canfield, yukon, russiansolitaire, scorpion, accordion, pokersquares, crescent, bakersdozen, beleagueredcastle, gaps, rummy500, eightoff |
