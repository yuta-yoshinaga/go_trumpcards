...
> **注意**: CUI版は常にノーマルモード（ババ抜き）で起動します。ジジ抜きモードはWeb版でのみ選択できます。
...
- CPUは端のカードを優先して引く傾向があるので、`shuffle` で手札を並べ替え、ジョーカーを端から遠ざけると有利です

> **Note**: CPU記憶AI（引いた位置を記憶して戦略的に選択する機能）はWeb版のみ対応しています。
