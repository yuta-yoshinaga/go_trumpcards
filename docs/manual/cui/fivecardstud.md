...
あなた チップ:999 VPIP:0% PFR:0% 3Bet:0% AF:-
  ドアカード: ♥10<
  ホールカード: ♥9
CPU 1 (TAG) チップ:999 VPIP:0% PFR:0% 3Bet:0% AF:-
  ドアカード: ♣13<
CPU 2 (LAP) チップ:997 VPIP:0% PFR:0% 3Bet:0% AF:- ベット:2
  ドアカード: ♣6<
CPU 3 (TAP) チップ:999 VPIP:0% PFR:0% 3Bet:0% AF:- [フォールド]
  ドアカード: ♣9<
----------
==========
```

- `テーブル: 6-max` / `ディーラー:` / `ポット:` / `リミット:`:
  **それぞれ独立した行**です
- `Ante:1 BringIn:2 SmallBet:5 BigBet:10`: 各種の額が**英語ラベルで 1 行**に
  並びます (`アンティ:` `ブリングイン:` `SB/BB:` のような行はありません)
- プレイヤー行: `あなた チップ:999 VPIP:0% PFR:0% 3Bet:0% AF:-` —
  統計は**同じ行**に並びます。`ベット:2` や `[フォールド]` は状況に応じて後ろに付きます
- `  ドアカード:` / `  ホールカード:`: 表向き札と裏向き札
  (`ドア:` / `ホール:` ではありません)
- **札の末尾の `<`**: **そのストリートで新しく配られた 1 枚**の印です
- `[ブリングイン]`: ブリングインを投入したプレイヤー
- `[フォールド]`: フォールド済み
- `[オールイン]`: オールイン状態
- `ポット`: 現在のポット額
- `<` 印: ドアカードのうち**そのストリートで新しく公開された1枚**に付きます（前回の画面と見比べずに、増えた情報が分かります）
