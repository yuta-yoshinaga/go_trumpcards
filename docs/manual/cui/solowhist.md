...
ソロ・ホイスト (Solo Whist)
==========
ラウンド: 1  トリック: 1  切り札: SPADE  (先取 21点で勝利)
宣言者: あなた — ソロ
あなた (宣言者): 13枚  得点: 0  トリック: 0
[0]SPADE 12  [1]SPADE 4  [2]CLOVER 11  [3]HEART 10  [4]HEART 4  [5]DIAMOND 13  ...
CPU 1 (ディフェンダー): 13枚  得点: 0  トリック: 0
CPU 2 (ディフェンダー): 13枚  得点: 0  トリック: 0
CPU 3 (ディフェンダー): 13枚  得点: 0  トリック: 0
----------
宣言者: 5/8 トリック (残り3)
手番: あなた
play <idx>・・・カードを出す（A高／リードスートにマストフォロー）
```

- **ラウンド行**: ラウンド・トリック番号と切り札、および**何点先取で勝ちか**。
- **宣言者行**: デクレアラーと成立した契約。入札中は出ません。
- **プレイヤー行**: 各プレイヤーの役割・手札枚数・累積得点・獲得トリック数。
