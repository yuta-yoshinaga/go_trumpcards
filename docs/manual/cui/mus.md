...
ムス (Mus)
==========
ラウンド: 1  チーム0: 0点  チーム1: 0点
あなた (チーム0, 0点): 4枚
[0]HEART 13  [1]HEART 12  [2]DIAMOND 7  [3]DIAMOND 5
手役評価: グランデ 10 / チカ 5 / パレス なし / フエゴ 32点（フエゴあり）
CPU 1 (チーム1, 0点): 4枚
CPU 2 (チーム0, 0点): 4枚
CPU 3 (チーム1, 0点): 4枚
----------
Mus か Corte か？
m / mus・・・手札交換   c / cut / corte・・・賭け開始
```
...
- **1 行目**: `ラウンド: N  チーム0: X点  チーム1: Y点` — ラウンドと
  両チームの得点が同じ行に並びます（`アマラコス:` という行はありません）
- **プレイヤー行**: `あなた (チーム0, 0点): 4枚` — 所属チーム・得点・手札枚数
- **`[n]`付き行**: あなたの手札（インデックス付き）。**次の行に出ます**
- **手役評価行**: あなたの手札を4つの賭けラウンドの視点で評価した値。グランデ=最高ランク、チカ=最低ランク、パレス=ペアの分類、フエゴ=合計点（31点ちょうどが最強、31未満はプント）
