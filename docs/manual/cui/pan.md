...
- 3・5・7 のセットは「バジェ（valle）」でチップ条件のひとつ。ラン、または4枚以上のセットもチップ条件です。メルドの行末に `チップNユニット`（バジェと別条件が重なる場合は2）が付きます。
...
捨て札: HEART 7
----------
[You]: 累積0点 チップ50 メルド0/11枚 手札11枚
[0]SPADE 3  [1]SPADE 4  [2]SPADE 5  ...
CPU 1: 累積0点 チップ50 メルド0/11枚 手札10枚
----------
手番: あなた (プレイフェーズ)
m <idx...>・・・メルドを場に出す
...
- ヘッダーの `あがり: メルド11枚` が勝利に必要な枚数です。各プレイヤー行の `メルド N/11枚` で、誰があと何枚かが一目で分かります。
