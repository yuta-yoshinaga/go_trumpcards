...
==========
ラウンド 1/11  ワイルド: 3  山札: 91枚
捨て札: HEART 12
あなた: 累積0点 ラウンド0点 3枚 デッドウッド28
[0]CLOVER 3~  [1]HEART 6  [2]DIAMOND 2
~ = ワイルド札（このラウンドのワイルドランク）
CPU 1: 累積0点 ラウンド0点 3枚 デッドウッド?
CPU 2: 累積0点 ラウンド0点 3枚 デッドウッド?
CPU 3: 累積0点 ラウンド0点 3枚 デッドウッド?
==========
```

- `ラウンド N/11  ワイルド: M  山札: X枚`: ラウンド番号・そのラウンドの
  ワイルドランク・山札の残り枚数が 1 行に並びます
- `捨て札: X`: 捨て札の一番上のカード
- `あなた: 累積N点 ラウンドM点 X枚 デッドウッドY`: 累積得点・このラウンドの
  得点・手札枚数・現在のデッドウッド点。**CPU の行は `デッドウッド?`** で、
  相手の点は伏せられています
- `[0]SPADE A`...: インデックス付きの手札カード。**そのラウンドのワイルドランクの札には末尾に `~` が付きます**
- `~ = ワイルド札`: 手札にワイルドがあるときだけ出る凡例行
