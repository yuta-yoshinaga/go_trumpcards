...
- 状況に応じたメッセージが出力される。**文言には打つコマンドが入っています**:
  - `あなたの番です。s (step) でカードをめくってください`
  - `ペア/サンドイッチ成立！ j (slap) で叩いてください`
  - `あなたが<ペアスラップ|サンドイッチスラップ|スラップ>で場札を獲得！`
    — **どの成立でスラップしたか**が文言に入ります
  - `チャンスバトル中: 残り N 回` / `チャンスバトル勝利！ 場札を獲得`
    / `チャンスバトルで CPU に場札を奪われた...`
  - `誤スラップ！ 1 枚 CPU に渡しました`
