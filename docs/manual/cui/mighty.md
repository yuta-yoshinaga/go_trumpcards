...
==========
ラウンド: 1  トリック: 0
あなた: ビッド=未ビッド 獲得0トリック 得点札0枚 累積0点 ラウンド0点 10枚
[0]JOKER  [1]SPADE 3  [2]SPADE 9  [3]SPADE 13  [4]CLOVER 3  [5]HEART 8  ...
CPU 1: ビッド=未ビッド 獲得0トリック 得点札0枚 累積0点 ラウンド0点 10枚
CPU 2: ビッド=未ビッド 獲得0トリック 得点札0枚 累積0点 ラウンド0点 10枚
CPU 3: ビッド=未ビッド 獲得0トリック 得点札0枚 累積0点 ラウンド0点 10枚
CPU 4: ビッド=未ビッド 獲得0トリック 得点札0枚 累積0点 ラウンド0点 10枚
----------
ビッドフェーズ: あなたの番
コマンド: b <数> [nt]   (0=パス、nt=ノートランプ)
ノートランプ (nt) を付けると、最低ビッドに +2 点が上乗せされます
==========
```

- `ラウンド: N  トリック: M`: 現在のラウンドとトリック番号
- プレイヤー行: `ビッド=... 獲得Nトリック 得点札M枚 累積X点 ラウンドY点 Z枚`。
  **ビッド前は `ビッド=未ビッド`**、契約が決まると宣言内容が入ります
- `[0]JOKER`...: インデックス付きの手札カード
- `トリック: あなた=SPADE 1, CPU 1=...`: プレイフェーズで、現在のトリックに
  出ている札。まだ 1 枚も出ていないトリックでは行ごと出ません
