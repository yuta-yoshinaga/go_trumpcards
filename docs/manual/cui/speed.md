...
CPU: 手札4枚 / 山札21枚
----------
[台札] [0] CLOVER 12 [1] CLOVER 13
----------
あなた: 手札4枚 / 山札21枚
[0]DIAMOND 7  [1]SPADE 4  [2]HEART 9  [3]HEART 13*
[ヒント] カード[3]を台札[0]に出せます
経過時間: 00:00
==========
```

- `CPU: 手札N枚 / 山札M枚`: CPU の手札枚数と山札残り枚数
- `[台札] [0] CLOVER 12 [1] CLOVER 13`: 中央の 2 つの台札（`[0]`=左, `[1]`=右）
- `あなた: 手札N枚 / 山札M枚`: あなたの手札枚数と山札残り枚数
- `[0]DIAMOND 7`, `[1]SPADE 4`...: インデックス付きの手札カード
- `[ヒント] カード[i]を台札[j]に出せます`: 出せる手がある間だけ出ます
- `経過時間: MM:SS`: 局の経過時間
