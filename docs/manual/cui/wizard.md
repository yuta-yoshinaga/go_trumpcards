...
Wizard (ウィザード)
==========
ラウンド: 1/15  手札枚数: 1  トリック: 0
切り札: CLOVER 13
ディーラー: あなた
あなた: ビッド=未ビッド 獲得0トリック 累積0点 ラウンド0点 1枚
[0]HEART 13
CPU 1: ビッド=0 獲得0トリック 累積0点 ラウンド0点 1枚
CPU 2: ビッド=0 獲得0トリック 累積0点 ラウンド0点 1枚
CPU 3: ビッド=0 獲得0トリック 累積0点 ラウンド0点 1枚
----------
ビッドフェーズ: あなたの番
合計ビッド: 1/1 (ぴったり)
b <n>・・・ビッドを宣言 (0-手札枚数)
...
- `ラウンド: N/15  手札枚数: X  トリック: T`: ラウンド・**そのラウンドの
  配り枚数**・トリック番号が 1 行に並びます
- `切り札: CLOVER 13`: 切り札を決めたカード（スート名だけの行ではありません）
- `ディーラー: 名前`: そのラウンドのディーラー
- プレイヤー行: `ビッド=... 獲得Nトリック 累積X点 ラウンドY点 Z枚`。
  **自分がまだ宣言していなければ `ビッド=未ビッド`**
...
- `合計ビッド: X/Y (...)`: ビッド済みの合計（未ビッドは0）と手札枚数。`オーバー` / `アンダー` / `ぴったり` のいずれかを表示します
