...
リミット: Fixed
----------
あなた チップ:970 VPIP:0% PFR:0% 3Bet:0% AF:- ベット:20
  手札: ♠1  ♥13  ♦5
...
- `テーブル:`: テーブルサイズ（4-max, 6-max, 9-max）
- `ディーラー:`: 現在のディーラー名
- `あなた`: プレイヤーのチップ残高・HUD統計・ベット額
- `手札`: あなたのホールカード（3枚。ディスカード後は2枚）
- `CPU N (スタイル)`: CPUのチップ残高、ベット額、状態
- `コミュニティ`: 場に公開されたコミュニティカード
- `ポット`: 現在のポット額
- `[学習モード]`: 人間の手番に表示。勝率（エクイティ）とポットオッズを比較し、コールの有利・不利を示す
