...
| 同スート縛り（Farbenzwang） | `2` | 切り札スートを指定し、**相手に1トリックも渡さない** | 5 |
| ベテル（Bettel） | `3` | **切り札なし**で、宣言者自身が**1トリックも取らない** | 6 |

全員がパスした場合は、ディーラーの左隣が手札で一番枚数の多いスートを切り札にして通常契約を行う。番号が大きいほど強い宣言で、点も高い。ベテルを最上位に置いているのは、追従必須・切り札なしの4人卓では「1つも取らない」が同スート縛りより通しにくいためです。
...
----------
トリック: CPU 1=♥11, CPU 2=♠10, CPU 3=♥12
あなた の番です
p <i> (プレイ) / m <i> (マリアージュ)
==========
```
