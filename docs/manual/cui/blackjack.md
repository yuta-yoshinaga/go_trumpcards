...
- **配当表**: ベットフェーズのあいだだけ、ブラックジャック 3:2 / 通常勝利 1:1 / インシュランス 2:1 / プッシュ / サレンダー / バストの一覧が出ます（Web の配当表と同じ内容）。Spanish 21 ではボーナス配当（5・6・7 枚で 21、6-7-8、7-7-7）も並びます。**サイドベットの配当**（パーフェクトペア、21+3）も続けて表示されます — `bet <額> [pp] [21+3]` はどちらのバリアントでも受け付けるので、賭ける前に倍率を確認できます
