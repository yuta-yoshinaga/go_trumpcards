...
[0]♠1  [1]♦3〈Monsieur〉  [2]♣7  [3]♥9〈GrandNeuf〉  [4]♠12
CPU1 (チーム1): 5枚  トリック: 0
CPU2 (チーム0): 5枚  トリック: 0
CPU3 (チーム1): 5枚  トリック: 0
----------
...
- **`〈名前〉`付きの札**: その札がリュエットであることを示します。`♦3` とだけ出ていたら最強札とは読めません。
- **プレイヤー行**: 所属チーム・手札枚数・このメーヌで取ったトリック数。`[親]` はディーラーです。
- **メーヌ結果**: 個人のトリック数に続けて `チーム合計` と `このメーヌを取ったのは …` が出ます。**勝敗を決めるのはチーム合計が3以上かどうか**で、4-1 でも 3-2 でも得点は同じ 1 点です。
