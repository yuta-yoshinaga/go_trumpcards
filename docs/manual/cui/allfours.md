...
==========
ラウンド: 1  トリック: 1  親: CPU 1
トランプ: ♦  めくり札: DIAMOND 7
あなた: 獲得0トリック 累積0点 ラウンド0点 6枚
[0]SPADE 2  [1]SPADE 7  [2]CLOVER 1  [3]HEART 10  [4]DIAMOND 10  [5]DIAMOND 1
[0] [1] [2] [3] [4] [5] の札が合法手です。
CPU 1: 獲得0トリック 累積0点 ラウンド0点 6枚
----------
得点内訳 （暫定。残りの切り札で High/Low は入れ替わります）
  High: なし
  Low: なし
  Jack: なし
  Game: なし
...
- 「めくり札」 は暫定の切り札を決めた1枚
- 手札はインデックス付きで表示
- プレイ中の人間の手番では、合法手のインデックスを次の行に表示
- 「得点内訳」 は High / Low / Jack / Game をそれぞれ誰が取ったか。**プレイ中は暫定**で、まだ出ていない切り札で High / Low は入れ替わります。該当なしのときは「なし」と出ます
