...
イギリスの古典的な一人用ペイシェンス。4 枚のエースを最初から組札に据え、残る 48 枚を 4 つのウェイスト（捨て札列）へ **1 段 4 枚ずつ**配りながら、組札を A から K まで積み上げる。
...
- 52 枚 1 組。**エース 4 枚を抜いて 4 つの組札に据え**、残る 48 枚を山札にする
...
- 52 枚すべてが組札に乗れば勝ち。山札を配り切り、どのウェイスト最上段も置けなくなれば手詰まり
...
- `F0`〜`F3` が組札。開始時点で 4 枚のエースが据わっているので `(1/13)` から始まります
