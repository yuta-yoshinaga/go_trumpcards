...
ブラウザでアプリを開き、ナビゲーションから「ビッド・ホイスト」を選択します。あなたはプレイヤー0（チーム0）で、対面のCPUがパートナー、両隣のCPUが対戦相手です。
...
- **「ヒント」ボタン**: 自分の手番で押すと、サーバーが今の局面での推奨を返します。押したときだけ表示されます。
