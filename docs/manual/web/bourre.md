...
ブラウザで `http://localhost:8080` にアクセスし、ナビゲーションバーから「ブーレ」を選択します。
...
- 各ハンドの流れ:
  ...
  5. 最も多くトリックを取ったプレイヤーがポットを総取り。参加したのに0トリックのプレイヤーは「ブーレ」となり、ポットと同額を次ポットへ支払います（**手持ちチップが足りなければ、その全額まで**）。最多が同数の場合はポットが次ハンドへ繰り越されます。
