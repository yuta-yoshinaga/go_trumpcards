...
4人（プレイヤー1人 + CPU 3人）で遊ぶテキサスホールデムポーカーです。各CPUは異なるプレイスタイル（TAG/LAP/TAP/LAG）を持ち、ブラフを含む戦略的なプレイをします。サイドポットにも対応しています。
...
1. **ブラインド**: ディーラーの左隣がスモールブラインド（5）、その左隣がビッグブラインド（10）を強制ベット
...
```
┌────────────────────────────────────────────┐
│ フェーズ: フロップ  ポット: 60  ディーラー: Player 0 │
├────────────────────────────────────────────┤
│           コミュニティカード                │
│      [♠7] [♣10] [♥3]                    │
├────────────────────────────────────────────┤
