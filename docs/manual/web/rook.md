...
Rook（ルーク）はアメリカ生まれの4人チーム制**ポイント・トリックテイキングゲーム**です。標準の52枚トランプではなく、専用の**57枚デッキ**（赤・黄・緑・黒の4色 × 1〜14 と、特別札「ルーク鳥（Rook Bird）」1枚）を使います。あなた（席0）とその対面がチームを組み、2人のCPUチームと対戦します。オークションでノルマ（契約点）を競い、トリックで得点札を奪い合い、先に**500点**へ到達したチームが勝ちます。
