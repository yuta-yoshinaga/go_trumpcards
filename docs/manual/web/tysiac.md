...
ブラウザで `http://localhost:8080` にアクセスし、ナビゲーションバーから「トゥシオンツ（1000）」を選択します。
...
1. 「ビッド」で宣言を 10 点ずつ引き上げるか、「パス」で降ります。
2. 最後まで残った人が落札者となり、タロン（伏せ札）を受け取ります。

### タロン交換フェーズ

1. 落札者はタロンを手札に加えます。
2. 相手それぞれに 1 枚ずつ渡すカードを選びます（計 2 回）。

### プレイフェーズ

1. 手札のカードをクリックして出します。フォロー義務があります。
2. 同スートの K と Q を揃えてリードすると**マリアージュ**が宣言され、切り札が変わります。
3. 「次のトリックへ」で次に進みます。

### ラウンド終了

宣言点に届いたかどうかで加減点され、「次のラウンドへ」で続行します。
