...
| 同スート縛り（Farbenzwang） | 切り札スートを指定し、**相手に1トリックも渡さない** | 5 |
| ベテル（Bettel） | **切り札なし**で、**宣言者自身が1トリックも取らない** | 6 |

全員がパスした場合は、ディーラーの左隣が手札で一番枚数の多いスートを切り札にして通常契約を行います。表の下ほど強い宣言で、点も高くなります。ベテルを最上位に置いているのは、追従必須・切り札なしの4人卓では「1つも取らない」が同スート縛りより通しにくいためです。ベテルでは宣言者が第1トリックをリードします。
