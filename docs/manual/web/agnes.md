...
アグネス・ソレル（Agnes Sorel）は1人用ソリティアで、クロンダイク式の7列タブローと、キャンフィールド式のベースランクから始まる4つの組札を組み合わせたゲーム。4つの組札をベースランクから始めて13枚ずつ積み上げれば勝利。
...
- **組札**: 同じスート、ベースランクから昇順で13枚まで積む（K→A→…とラップアラウンド）
...
- ベースランクから昇順に積み上げるため、タブローの末尾カードを優先的に組札へ送る
