...
├────────────────────────────────────────────┤
│  あなた: 手札4枚 / 文字[P/PIG]              │
│  CPU1 [選択済み]: 手札4枚 / 文字[-/PIG]     │
│  CPU2 [2番目に気づいた]: 手札4枚/文字[PI/PIG]│
│  CPU3 [脱落]: 手札0枚 / 文字[PIG/PIG]       │
├────────────────────────────────────────────┤
│  あなたの手札（渡せるときに緑の枠）          │
├────────────────────────────────────────────┤
│  [気づいた！] [次のラウンドへ] [リセット]    │
...
- **席の行**: 手札の枚数と溜まった文字。**文字がそのまま残機**なので、得点表示はありません。`文字[PI/PIG]` の右側は目標語で、**3文字揃うと脱落**——あと何回で終わりかが 0 文字の席でも読めます
