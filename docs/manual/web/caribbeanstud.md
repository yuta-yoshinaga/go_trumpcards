...
│              役名: ロイヤルフラッシュ          │
│                                            │
│  ベット: アンテ [100]  ジャックポット [10]    │
│  [ベット] [コール] [フォールド] [リセット]     │
└────────────────────────────────────────────┘
```

- **ヘッダー**: チップ残高と現在のフェーズ（BET / ACTION / RESULT）
- **ディーラーエリア**: 画面上部。ACTIONフェーズでは伏せ、RESULTフェーズで公開
- **プレイヤーエリア**: 画面中央。自分の手札と役名を表示
- **ベット入力**: アンテとジャックポットの金額入力欄
- **操作ボタン**: フェーズに応じてベット/コール/フォールド/リセットが有効
