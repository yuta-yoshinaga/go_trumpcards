...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全297ゲーム)](#12-ゲームドメイン-全297ゲーム)
...
classDiagram
    ...
    note for GameCuiController "297ゲーム × CUI/Web = 594 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "297ゲーム × CUI/Web = 594 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 297 controllers
    GameManager --> "*" CuiExecer : holds 297 games
