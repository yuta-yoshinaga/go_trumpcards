...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全294ゲーム)](#12-ゲームドメイン-全294ゲーム)
...
classDiagram
    ...
    note for GameCuiController "294ゲーム × CUI/Web = 588 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "294ゲーム × CUI/Web = 588 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 294 controllers
    GameManager --> "*" CuiExecer : holds 294 games
