...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全350ゲーム)](#12-ゲームドメイン-全350ゲーム)
...
classDiagram
    ...
    note for GameCuiController "350ゲーム × CUI/Web = 700 バインディング\n実装型は 674 種類 (CuiController 337 + WebController 337)\n差分は複数ゲームで共有される Controller\n(総称基底 GameWebController[I,P,O] は別)"
    note for GameCuiPresenter "350ゲーム × CUI/Web = 700 バインディング\n実装型は 676 種類 (CuiPresenter 338 + WebPresenter 338)"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 350 controllers
    GameManager --> "*" CuiExecer : holds 350 games
