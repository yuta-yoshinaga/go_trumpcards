...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全375ゲーム)](#12-ゲームドメイン-全375ゲーム)
...
classDiagram
    ...
    note for GameCuiController "375ゲーム × CUI/Web = 750 バインディング\n実装型は 718 種類 (CuiController 359 + WebController 359)\n差分は複数ゲームで共有される Controller\n(総称基底 GameWebController[I,P,O] は別)"
    note for GameCuiPresenter "375ゲーム × CUI/Web = 750 バインディング\n実装型は 720 種類 (CuiPresenter 360 + WebPresenter 360)"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 375 controllers
    GameManager --> "*" CuiExecer : holds 375 games
