...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全378ゲーム)](#12-ゲームドメイン-全378ゲーム)
...
classDiagram
    ...
    note for GameCuiController "378ゲーム × CUI/Web = 756 バインディング\n実装型は 722 種類 (CuiController 361 + WebController 361)\n差分は複数ゲームで共有される Controller\n(総称基底 GameWebController[I,P,O] は別)"
    note for GameCuiPresenter "378ゲーム × CUI/Web = 756 バインディング\n実装型は 724 種類 (CuiPresenter 362 + WebPresenter 362)"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 378 controllers
    GameManager --> "*" CuiExecer : holds 378 games
