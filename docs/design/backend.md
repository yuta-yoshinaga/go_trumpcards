...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全121ゲーム)](#12-ゲームドメイン-全121ゲーム)
...
classDiagram
    ...
    note for GameCuiController "121ゲーム × CUI/Web = 242 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "121ゲーム × CUI/Web = 242 Presenter 実装"
```
