...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全305ゲーム)](#12-ゲームドメイン-全305ゲーム)
...
classDiagram
    ...
    note for GameCuiController "305ゲーム × CUI/Web = 610 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "305ゲーム × CUI/Web = 610 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 305 controllers
    GameManager --> "*" CuiExecer : holds 305 games
