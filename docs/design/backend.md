...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全286ゲーム)](#12-ゲームドメイン-全286ゲーム)
...
classDiagram
    ...
    note for GameCuiController "286ゲーム × CUI/Web = 572 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "286ゲーム × CUI/Web = 572 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 286 controllers
    GameManager --> "*" CuiExecer : holds 286 games
