...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全354ゲーム)](#12-ゲームドメイン-全354ゲーム)
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 354 controllers
    GameManager --> "*" CuiExecer : holds 354 games
