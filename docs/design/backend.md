...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全274ゲーム)](#12-ゲームドメイン-全274ゲーム)
...
classDiagram
    ...
    note for GameCuiController "274ゲーム × CUI/Web = 548 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "274ゲーム × CUI/Web = 548 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 274 controllers
    GameManager --> "*" CuiExecer : holds 274 games
