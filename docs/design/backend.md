...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全356ゲーム)](#12-ゲームドメイン-全356ゲーム)
...
classDiagram
    ...
    note for GameCuiController "356ゲーム × CUI/Web = 712 バインディング\n実装型は 682 種類 (CuiController 341 + WebController 341)\n差分は複数ゲームで共有される Controller\n(総称基底 GameWebController[I,P,O] は別)"
    note for GameCuiPresenter "356ゲーム × CUI/Web = 712 バインディング\n実装型は 684 種類 (CuiPresenter 342 + WebPresenter 342)"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 356 controllers
    GameManager --> "*" CuiExecer : holds 356 games
