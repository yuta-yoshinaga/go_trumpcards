...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全303ゲーム)](#12-ゲームドメイン-全303ゲーム)
...
classDiagram
    ...
    note for GameCuiController "303ゲーム × CUI/Web = 606 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "303ゲーム × CUI/Web = 606 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 303 controllers
    GameManager --> "*" CuiExecer : holds 303 games
