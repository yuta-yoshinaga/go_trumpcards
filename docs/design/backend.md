...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全344ゲーム)](#12-ゲームドメイン-全344ゲーム)
...
classDiagram
    ...
    note for GameCuiController "344ゲーム × CUI/Web = 688 バインディング\n実装型は 662 種類 (CuiController 331 + WebController 331)\n差分は複数ゲームで共有される Controller\n(総称基底 GameWebController[I,P,O] は別)"
    note for GameCuiPresenter "344ゲーム × CUI/Web = 688 バインディング\n実装型は 664 種類 (CuiPresenter 332 + WebPresenter 332)"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 344 controllers
    GameManager --> "*" CuiExecer : holds 344 games
