...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全268ゲーム)](#12-ゲームドメイン-全268ゲーム)
...
classDiagram
    ...
    note for GameCuiController "268ゲーム × CUI/Web = 536 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "268ゲーム × CUI/Web = 536 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 268 controllers
    GameManager --> "*" CuiExecer : holds 268 games
