...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全353ゲーム)](#12-ゲームドメイン-全353ゲーム)
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 353 controllers
    GameManager --> "*" CuiExecer : holds 353 games
