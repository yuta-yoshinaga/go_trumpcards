...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全293ゲーム)](#12-ゲームドメイン-全293ゲーム)
...
classDiagram
    ...
    note for GameCuiController "293ゲーム × CUI/Web = 586 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "293ゲーム × CUI/Web = 586 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 293 controllers
    GameManager --> "*" CuiExecer : holds 293 games
