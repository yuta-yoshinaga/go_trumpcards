...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全381ゲーム)](#12-ゲームドメイン-全381ゲーム)
...
classDiagram
    ...
    note for GameCuiController "381ゲーム × CUI/Web = 762 バインディング\n実装型は 728 種類 (CuiController 364 + WebController 364)\n差分は複数ゲームで共有される Controller\n(総称基底 GameWebController[I,P,O] は別)"
    note for GameCuiPresenter "381ゲーム × CUI/Web = 762 バインディング\n実装型は 730 種類 (CuiPresenter 365 + WebPresenter 365)"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 381 controllers
    GameManager --> "*" CuiExecer : holds 381 games
