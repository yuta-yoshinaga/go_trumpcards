...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全365ゲーム)](#12-ゲームドメイン-全365ゲーム)
...
classDiagram
    ...
    note for GameCuiController "365ゲーム × CUI/Web = 730 バインディング\n実装型は 700 種類 (CuiController 350 + WebController 350)\n差分は複数ゲームで共有される Controller\n(総称基底 GameWebController[I,P,O] は別)"
    note for GameCuiPresenter "365ゲーム × CUI/Web = 730 バインディング\n実装型は 702 種類 (CuiPresenter 351 + WebPresenter 351)"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 365 controllers
    GameManager --> "*" CuiExecer : holds 365 games
