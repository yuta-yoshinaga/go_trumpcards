...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全345ゲーム)](#12-ゲームドメイン-全345ゲーム)
...
classDiagram
    ...
    note for GameCuiController "345ゲーム × CUI/Web = 690 バインディング\n実装型は 664 種類 (CuiController 332 + WebController 332)\n差分は複数ゲームで共有される Controller\n(総称基底 GameWebController[I,P,O] は別)"
    note for GameCuiPresenter "345ゲーム × CUI/Web = 690 バインディング\n実装型は 666 種類 (CuiPresenter 333 + WebPresenter 333)"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 345 controllers
    GameManager --> "*" CuiExecer : holds 345 games
