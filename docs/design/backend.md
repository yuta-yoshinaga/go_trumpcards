...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全359ゲーム)](#12-ゲームドメイン-全359ゲーム)
...
classDiagram
    ...
    note for GameCuiController "359ゲーム × CUI/Web = 718 バインディング\n実装型は 688 種類 (CuiController 344 + WebController 344)\n差分は複数ゲームで共有される Controller\n(総称基底 GameWebController[I,P,O] は別)"
    note for GameCuiPresenter "359ゲーム × CUI/Web = 718 バインディング\n実装型は 690 種類 (CuiPresenter 345 + WebPresenter 345)"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 359 controllers
    GameManager --> "*" CuiExecer : holds 359 games
