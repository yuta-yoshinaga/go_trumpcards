...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全279ゲーム)](#12-ゲームドメイン-全279ゲーム)
...
classDiagram
    ...
    note for GameCuiController "279ゲーム × CUI/Web = 558 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "279ゲーム × CUI/Web = 558 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 279 controllers
    GameManager --> "*" CuiExecer : holds 279 games
