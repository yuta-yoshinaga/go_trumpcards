...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全284ゲーム)](#12-ゲームドメイン-全284ゲーム)
...
classDiagram
    ...
    note for GameCuiController "284ゲーム × CUI/Web = 568 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "284ゲーム × CUI/Web = 568 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 284 controllers
    GameManager --> "*" CuiExecer : holds 284 games
