...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全285ゲーム)](#12-ゲームドメイン-全285ゲーム)
...
classDiagram
    ...
    note for GameCuiController "285ゲーム × CUI/Web = 570 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "285ゲーム × CUI/Web = 570 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 285 controllers
    GameManager --> "*" CuiExecer : holds 285 games
