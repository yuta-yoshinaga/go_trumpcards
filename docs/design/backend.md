...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全287ゲーム)](#12-ゲームドメイン-全287ゲーム)
...
classDiagram
    ...
    note for GameCuiController "287ゲーム × CUI/Web = 574 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "287ゲーム × CUI/Web = 574 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 287 controllers
    GameManager --> "*" CuiExecer : holds 287 games
