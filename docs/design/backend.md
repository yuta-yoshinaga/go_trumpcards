...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全302ゲーム)](#12-ゲームドメイン-全302ゲーム)
...
classDiagram
    ...
    note for GameCuiController "302ゲーム × CUI/Web = 604 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "302ゲーム × CUI/Web = 604 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 302 controllers
    GameManager --> "*" CuiExecer : holds 302 games
