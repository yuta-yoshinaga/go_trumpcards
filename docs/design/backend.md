...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全370ゲーム)](#12-ゲームドメイン-全370ゲーム)
...
classDiagram
    ...
    note for GameCuiController "370ゲーム × CUI/Web = 740 バインディング\n実装型は 708 種類 (CuiController 354 + WebController 354)\n差分は複数ゲームで共有される Controller\n(総称基底 GameWebController[I,P,O] は別)"
    note for GameCuiPresenter "370ゲーム × CUI/Web = 740 バインディング\n実装型は 710 種類 (CuiPresenter 355 + WebPresenter 355)"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 370 controllers
    GameManager --> "*" CuiExecer : holds 370 games
