...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全380ゲーム)](#12-ゲームドメイン-全380ゲーム)
...
classDiagram
    ...
    note for GameCuiController "380ゲーム × CUI/Web = 760 バインディング\n実装型は 726 種類 (CuiController 363 + WebController 363)\n差分は複数ゲームで共有される Controller\n(総称基底 GameWebController[I,P,O] は別)"
    note for GameCuiPresenter "380ゲーム × CUI/Web = 760 バインディング\n実装型は 728 種類 (CuiPresenter 364 + WebPresenter 364)"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 380 controllers
    GameManager --> "*" CuiExecer : holds 380 games
