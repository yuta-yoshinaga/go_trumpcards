...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全288ゲーム)](#12-ゲームドメイン-全288ゲーム)
...
classDiagram
    ...
    note for GameCuiController "288ゲーム × CUI/Web = 576 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "288ゲーム × CUI/Web = 576 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 288 controllers
    GameManager --> "*" CuiExecer : holds 288 games
