...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全352ゲーム)](#12-ゲームドメイン-全352ゲーム)
...
classDiagram
    ...
    note for GameCuiController "352ゲーム × CUI/Web = 704 バインディング\n実装型は 678 種類 (CuiController 339 + WebController 339)\n差分は複数ゲームで共有される Controller\n(総称基底 GameWebController[I,P,O] は別)"
    note for GameCuiPresenter "352ゲーム × CUI/Web = 704 バインディング\n実装型は 680 種類 (CuiPresenter 340 + WebPresenter 340)"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 352 controllers
    GameManager --> "*" CuiExecer : holds 352 games
