...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全314ゲーム)](#12-ゲームドメイン-全314ゲーム)
...
- [3. ステートマシン図](#3-ステートマシン図)
  ...
  - [3.10 GinRummy フェーズ遷移](#314-ginrummy-フェーズ遷移)
  - [3.11 Baccarat フェーズ遷移](#314-baccarat-フェーズ遷移)
  - [3.12 Napoleon フェーズ遷移](#314-napoleon-フェーズ遷移)
  - [3.13 IndianPoker フェーズ遷移](#314-indianpoker-フェーズ遷移)
...
classDiagram
    ...
    note for GameCuiController "314ゲーム × CUI/Web = 628 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "314ゲーム × CUI/Web = 628 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 314 controllers
    GameManager --> "*" CuiExecer : holds 314 games
