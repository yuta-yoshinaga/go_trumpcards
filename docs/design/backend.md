...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全292ゲーム)](#12-ゲームドメイン-全292ゲーム)
...
classDiagram
    ...
    note for GameCuiController "292ゲーム × CUI/Web = 584 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "292ゲーム × CUI/Web = 584 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 292 controllers
    GameManager --> "*" CuiExecer : holds 292 games
