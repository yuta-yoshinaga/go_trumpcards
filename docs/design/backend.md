...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全369ゲーム)](#12-ゲームドメイン-全369ゲーム)
...
classDiagram
    ...
    note for GameCuiController "369ゲーム × CUI/Web = 738 バインディング\n実装型は 706 種類 (CuiController 353 + WebController 353)\n差分は複数ゲームで共有される Controller\n(総称基底 GameWebController[I,P,O] は別)"
    note for GameCuiPresenter "369ゲーム × CUI/Web = 738 バインディング\n実装型は 708 種類 (CuiPresenter 354 + WebPresenter 354)"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 369 controllers
    GameManager --> "*" CuiExecer : holds 369 games
