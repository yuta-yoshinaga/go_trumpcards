...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全275ゲーム)](#12-ゲームドメイン-全275ゲーム)
...
classDiagram
    ...
    note for GameCuiController "275ゲーム × CUI/Web = 550 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "275ゲーム × CUI/Web = 550 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 275 controllers
    GameManager --> "*" CuiExecer : holds 275 games
