...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全290ゲーム)](#12-ゲームドメイン-全290ゲーム)
...
classDiagram
    ...
    note for GameCuiController "290ゲーム × CUI/Web = 580 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "290ゲーム × CUI/Web = 580 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 290 controllers
    GameManager --> "*" CuiExecer : holds 290 games
