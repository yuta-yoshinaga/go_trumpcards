...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全382ゲーム)](#12-ゲームドメイン-全382ゲーム)
...
classDiagram
    ...
    note for GameCuiController "382ゲーム × CUI/Web = 764 バインディング\n実装型は 730 種類 (CuiController 365 + WebController 365)\n差分は複数ゲームで共有される Controller\n(総称基底 GameWebController[I,P,O] は別)"
    note for GameCuiPresenter "382ゲーム × CUI/Web = 764 バインディング\n実装型は 732 種類 (CuiPresenter 366 + WebPresenter 366)"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 382 controllers
    GameManager --> "*" CuiExecer : holds 382 games
