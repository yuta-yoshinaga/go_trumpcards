...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全379ゲーム)](#12-ゲームドメイン-全379ゲーム)
...
classDiagram
    ...
    note for GameCuiController "379ゲーム × CUI/Web = 758 バインディング\n実装型は 724 種類 (CuiController 362 + WebController 362)\n差分は複数ゲームで共有される Controller\n(総称基底 GameWebController[I,P,O] は別)"
    note for GameCuiPresenter "379ゲーム × CUI/Web = 758 バインディング\n実装型は 726 種類 (CuiPresenter 363 + WebPresenter 363)"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 379 controllers
    GameManager --> "*" CuiExecer : holds 379 games
