...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全265ゲーム)](#12-ゲームドメイン-全265ゲーム)
...
classDiagram
    ...
    note for GameCuiController "265ゲーム × CUI/Web = 530 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "265ゲーム × CUI/Web = 530 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 265 controllers
    GameManager --> "*" CuiExecer : holds 265 games
