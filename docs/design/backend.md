...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全282ゲーム)](#12-ゲームドメイン-全282ゲーム)
...
classDiagram
    ...
    note for GameCuiController "282ゲーム × CUI/Web = 564 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "282ゲーム × CUI/Web = 564 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 282 controllers
    GameManager --> "*" CuiExecer : holds 282 games
