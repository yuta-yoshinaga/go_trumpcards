...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全376ゲーム)](#12-ゲームドメイン-全376ゲーム)
...
classDiagram
    ...
    note for GameCuiController "376ゲーム × CUI/Web = 752 バインディング\n実装型は 720 種類 (CuiController 360 + WebController 360)\n差分は複数ゲームで共有される Controller\n(総称基底 GameWebController[I,P,O] は別)"
    note for GameCuiPresenter "376ゲーム × CUI/Web = 752 バインディング\n実装型は 722 種類 (CuiPresenter 361 + WebPresenter 361)"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 376 controllers
    GameManager --> "*" CuiExecer : holds 376 games
