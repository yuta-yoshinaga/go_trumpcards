...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全298ゲーム)](#12-ゲームドメイン-全298ゲーム)
...
classDiagram
    ...
    note for GameCuiController "298ゲーム × CUI/Web = 596 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "298ゲーム × CUI/Web = 596 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 298 controllers
    GameManager --> "*" CuiExecer : holds 298 games
