...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全377ゲーム)](#12-ゲームドメイン-全377ゲーム)
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 377 controllers
    GameManager --> "*" CuiExecer : holds 377 games
