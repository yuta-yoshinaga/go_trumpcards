...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全307ゲーム)](#12-ゲームドメイン-全307ゲーム)
...
classDiagram
    ...
    note for GameCuiController "307ゲーム × CUI/Web = 614 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "307ゲーム × CUI/Web = 614 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 307 controllers
    GameManager --> "*" CuiExecer : holds 307 games
