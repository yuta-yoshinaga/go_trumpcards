...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全357ゲーム)](#12-ゲームドメイン-全357ゲーム)
...
classDiagram
    ...
    note for GameCuiController "357ゲーム × CUI/Web = 714 バインディング\n実装型は 684 種類 (CuiController 342 + WebController 342)\n差分は複数ゲームで共有される Controller\n(総称基底 GameWebController[I,P,O] は別)"
    note for GameCuiPresenter "357ゲーム × CUI/Web = 714 バインディング\n実装型は 686 種類 (CuiPresenter 343 + WebPresenter 343)"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 357 controllers
    GameManager --> "*" CuiExecer : holds 357 games
