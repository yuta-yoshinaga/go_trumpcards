...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全351ゲーム)](#12-ゲームドメイン-全351ゲーム)
...
classDiagram
    ...
    note for GameCuiController "351ゲーム × CUI/Web = 702 バインディング\n実装型は 676 種類 (CuiController 338 + WebController 338)\n差分は複数ゲームで共有される Controller\n(総称基底 GameWebController[I,P,O] は別)"
    note for GameCuiPresenter "351ゲーム × CUI/Web = 702 バインディング\n実装型は 678 種類 (CuiPresenter 339 + WebPresenter 339)"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 351 controllers
    GameManager --> "*" CuiExecer : holds 351 games
