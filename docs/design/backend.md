...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全276ゲーム)](#12-ゲームドメイン-全276ゲーム)
...
classDiagram
    ...
    note for GameCuiController "276ゲーム × CUI/Web = 552 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "276ゲーム × CUI/Web = 552 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 276 controllers
    GameManager --> "*" CuiExecer : holds 276 games
