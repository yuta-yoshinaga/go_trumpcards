...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全281ゲーム)](#12-ゲームドメイン-全281ゲーム)
...
classDiagram
    ...
    note for GameCuiController "281ゲーム × CUI/Web = 562 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "281ゲーム × CUI/Web = 562 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 281 controllers
    GameManager --> "*" CuiExecer : holds 281 games
