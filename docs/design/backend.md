...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全304ゲーム)](#12-ゲームドメイン-全304ゲーム)
...
classDiagram
    ...
    note for GameCuiController "304ゲーム × CUI/Web = 608 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "304ゲーム × CUI/Web = 608 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 304 controllers
    GameManager --> "*" CuiExecer : holds 304 games
