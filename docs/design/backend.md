...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全269ゲーム)](#12-ゲームドメイン-全269ゲーム)
...
classDiagram
    ...
    note for GameCuiController "269ゲーム × CUI/Web = 538 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "269ゲーム × CUI/Web = 538 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 269 controllers
    GameManager --> "*" CuiExecer : holds 269 games
