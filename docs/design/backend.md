...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全295ゲーム)](#12-ゲームドメイン-全295ゲーム)
...
classDiagram
    ...
    note for GameCuiController "295ゲーム × CUI/Web = 590 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "295ゲーム × CUI/Web = 590 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 295 controllers
    GameManager --> "*" CuiExecer : holds 295 games
