...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全296ゲーム)](#12-ゲームドメイン-全296ゲーム)
...
classDiagram
    ...
    note for GameCuiController "296ゲーム × CUI/Web = 592 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "296ゲーム × CUI/Web = 592 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 296 controllers
    GameManager --> "*" CuiExecer : holds 296 games
