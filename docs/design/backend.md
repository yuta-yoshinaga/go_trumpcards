...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全283ゲーム)](#12-ゲームドメイン-全283ゲーム)
...
classDiagram
    ...
    note for GameCuiController "283ゲーム × CUI/Web = 566 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "283ゲーム × CUI/Web = 566 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 283 controllers
    GameManager --> "*" CuiExecer : holds 283 games
