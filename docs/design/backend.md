...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全270ゲーム)](#12-ゲームドメイン-全270ゲーム)
...
classDiagram
    ...
    note for GameCuiController "270ゲーム × CUI/Web = 540 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "270ゲーム × CUI/Web = 540 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 270 controllers
    GameManager --> "*" CuiExecer : holds 270 games
