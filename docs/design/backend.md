...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全299ゲーム)](#12-ゲームドメイン-全299ゲーム)
...
classDiagram
    ...
    note for GameCuiController "299ゲーム × CUI/Web = 598 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "299ゲーム × CUI/Web = 598 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 299 controllers
    GameManager --> "*" CuiExecer : holds 299 games
