...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全360ゲーム)](#12-ゲームドメイン-全360ゲーム)
...
classDiagram
    ...
    note for GameCuiController "360ゲーム × CUI/Web = 720 バインディング\n実装型は 690 種類 (CuiController 345 + WebController 345)\n差分は複数ゲームで共有される Controller\n(総称基底 GameWebController[I,P,O] は別)"
    note for GameCuiPresenter "360ゲーム × CUI/Web = 720 バインディング\n実装型は 692 種類 (CuiPresenter 346 + WebPresenter 346)"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 360 controllers
    GameManager --> "*" CuiExecer : holds 360 games
