...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全315ゲーム)](#12-ゲームドメイン-全315ゲーム)
...
- [3. ステートマシン図](#3-ステートマシン図)
  ...
  - [3.10 GinRummy フェーズ遷移](#315-ginrummy-フェーズ遷移)
  - [3.11 Baccarat フェーズ遷移](#315-baccarat-フェーズ遷移)
  - [3.12 Napoleon フェーズ遷移](#315-napoleon-フェーズ遷移)
  - [3.13 IndianPoker フェーズ遷移](#315-indianpoker-フェーズ遷移)
  - [3.14 VideoPoker フェーズ遷移](#315-videopoker-フェーズ遷移)
...
classDiagram
    ...
    note for GameCuiController "315ゲーム × CUI/Web = 630 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "315ゲーム × CUI/Web = 630 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 315 controllers
    GameManager --> "*" CuiExecer : holds 315 games
