...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全309ゲーム)](#12-ゲームドメイン-全309ゲーム)
...
classDiagram
    ...
    note for GameCuiController "309ゲーム × CUI/Web = 618 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "309ゲーム × CUI/Web = 618 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 309 controllers
    GameManager --> "*" CuiExecer : holds 309 games
