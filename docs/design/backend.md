...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全343ゲーム)](#12-ゲームドメイン-全343ゲーム)
...
classDiagram
    ...
    note for GameCuiController "343ゲーム × CUI/Web = 686 バインディング\n実装型は 660 種類 (CuiController 330 + WebController 330)\n差分は複数ゲームで共有される Controller\n(総称基底 GameWebController[I,P,O] は別)"
    note for GameCuiPresenter "343ゲーム × CUI/Web = 686 バインディング\n実装型は 662 種類 (CuiPresenter 331 + WebPresenter 331)"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 343 controllers
    GameManager --> "*" CuiExecer : holds 343 games
