...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全358ゲーム)](#12-ゲームドメイン-全358ゲーム)
...
classDiagram
    ...
    note for GameCuiController "358ゲーム × CUI/Web = 716 バインディング\n実装型は 686 種類 (CuiController 343 + WebController 343)\n差分は複数ゲームで共有される Controller\n(総称基底 GameWebController[I,P,O] は別)"
    note for GameCuiPresenter "358ゲーム × CUI/Web = 716 バインディング\n実装型は 688 種類 (CuiPresenter 344 + WebPresenter 344)"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 358 controllers
    GameManager --> "*" CuiExecer : holds 358 games
