...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全306ゲーム)](#12-ゲームドメイン-全306ゲーム)
...
classDiagram
    ...
    note for GameCuiController "306ゲーム × CUI/Web = 612 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "306ゲーム × CUI/Web = 612 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 306 controllers
    GameManager --> "*" CuiExecer : holds 306 games
