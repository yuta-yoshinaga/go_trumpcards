...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全280ゲーム)](#12-ゲームドメイン-全280ゲーム)
...
classDiagram
    ...
    note for GameCuiController "280ゲーム × CUI/Web = 560 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "280ゲーム × CUI/Web = 560 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 280 controllers
    GameManager --> "*" CuiExecer : holds 280 games
