...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全289ゲーム)](#12-ゲームドメイン-全289ゲーム)
...
classDiagram
    ...
    note for GameCuiController "289ゲーム × CUI/Web = 578 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "289ゲーム × CUI/Web = 578 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 289 controllers
    GameManager --> "*" CuiExecer : holds 289 games
