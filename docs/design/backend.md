...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全338ゲーム)](#12-ゲームドメイン-全338ゲーム)
...
classDiagram
    ...
    note for GameCuiController "338ゲーム × CUI/Web = 676 バインディング\n実装型は 650 種類 (CuiController 325 + WebController 325)\n差分は複数ゲームで共有される Controller\n(総称基底 GameWebController[I,P,O] は別)"
    note for GameCuiPresenter "338ゲーム × CUI/Web = 676 バインディング\n実装型は 652 種類 (CuiPresenter 326 + WebPresenter 326)"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 338 controllers
    GameManager --> "*" CuiExecer : holds 338 games
