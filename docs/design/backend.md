...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全308ゲーム)](#12-ゲームドメイン-全308ゲーム)
...
classDiagram
    ...
    note for GameCuiController "308ゲーム × CUI/Web = 616 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "308ゲーム × CUI/Web = 616 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 308 controllers
    GameManager --> "*" CuiExecer : holds 308 games
