...
- [1. クラス図](#1-クラス図)
  ...
  - [1.2 ゲームドメイン (全271ゲーム)](#12-ゲームドメイン-全271ゲーム)
...
classDiagram
    ...
    note for GameCuiController "271ゲーム × CUI/Web = 542 Controller\nGameCuiController / GameWebController は\n各ゲーム毎に具体的な実装が存在"
    note for GameCuiPresenter "271ゲーム × CUI/Web = 542 Presenter 実装"
```
...
classDiagram
    ...
    gameEntry --> GameWebController : holds 271 controllers
    GameManager --> "*" CuiExecer : holds 271 games
