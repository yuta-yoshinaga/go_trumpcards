...
| **extra3** | `cmd/workers/extra3/main.go` | 25 | `basra`, `belote`, `bouillotte`, `bridge`, `cego`, `congress`, `cribbage`, `fortyandeight`, `jass`, `koikoi`, `loo`, `mao`, `michigan`, `ombre`, `piquet`, `primero`, `rook`, `scarto`, `sevenbridge`, `sheepshead`, `skat`, `tablanet`, `terrace`, `ulti`, `wizard` |
