...
| **extra2** | `cmd/workers/extra2/main.go` | 32 | `americantoad`, `beggarmyneighbour`, `bigtwo`, `bisley`, `braid`, `cuarenta`, `cuckoo`, `doubleklondike`, `doubt`, `duchess`, `faro`, `fiftyone`, `gofish`, `grandfathersclock`, `kemps`, `mighty`, `missmilligan`, `napoleonssquare`, `nertz`, `pigtail`, `pinochle`, `pishti`, `pontoon`, `sirtommy`, `sixcardgolf`, `speed`, `spiteandmalice`, `spoons`, `tichu`, `trash`, `war`, `windmill` |
