...
| **extra2** | `cmd/workers/extra2/main.go` | 44 | `aluette`, `americantoad`, `auldlangsyne`, `beggarmyneighbour`, `bideuchre`, `bigtwo`, `bisley`, `braid`, `chineseten`, `cuarenta`, `cuckoo`, `doubleklondike`, `doubt`, `duchess`, `faro`, `fiftyone`, `gofish`, `grandfathersclock`, `guandan`, `kemps`, `laughandliedown`, `loba`, `mighty`, `missmilligan`, `mushi`, `napoleonssquare`, `nertz`, `pigtail`, `pinochle`, `pishti`, `pontoon`, `settemezzo`, `sirtommy`, `sixbidsolo`, `sixcardgolf`, `sjavs`, `speed`, `spiteandmalice`, `spoons`, `tichu`, `trash`, `war`, `windmill`, `zwicker` |
