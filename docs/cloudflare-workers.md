...
|--------|-------------|-------|---------------|
| **casino** | `cmd/workers/casino/main.go` | 38 | `poker`, `holdem`, `omaha`, `omahahilo`, `bigo`, `bigohilo`, `courchevel`, `shortdeck`, `pineapple`, `crazypineapple`, `irishpoker`, `baccarat`, `indianpoker`, `threecard`, `sevencardstud`, `caribbeanstud`, `texasholdembonus`, `badugi`, `deucetoseven`, `razz`, `sevencardstudhilo`, `ultimatetexasholdem`, `casinoholdem`, `chinesepoker`, `threecardbrag`, `teenpatti`, `fivecardstud`, `openfacechinese`, `soko`, `cincinnati`, `ironcross`, `baseballpoker`, `horse`, `followthequeen`, `dramaha`, `chicago`, `eightgame`, `courchevelhilo` |
...
| **extra** | `cmd/workers/extra/main.go` | 25 | `indianrummy`, `contractrummy`, `streetsandalleys`, `kingalbert`, `sultan`, `rummy500`, `ganjifa`, `kalooki`, `threethirteen`, `king`, `cinch`, `watten`, `carioca`, `machiavelli`, `pan`, `gostop`, `hachihachi`, `frenchtarot`, `koenigrufen`, `diplomat`, `zwanzigerrufen`, `troggu`, `sthelena`, `matrimony`, `tapptarock` |
