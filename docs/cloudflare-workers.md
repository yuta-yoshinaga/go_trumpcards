...
| **extra3** | `cmd/workers/extra3/main.go` | 42 | `basra`, `bigben`, `belote`, `boston`, `bouillotte`, `bridge`, `bura`, `congress`, `cribbage`, `desmoche`, `fortyandeight`, `hasenpfeffer`, `jass`, `kaiser`, `kille`, `klaberjass`, `koikoi`, `loo`, `mao`, `minibridge`, `nainjaune`, `niuniu`, `poch`, `popejoan`, `primero`, `rollingstone`, `rook`, `sakura`, `saliclaw`, `sevenbridge`, `ramsch`, `skat`, `skitgubbe`, `stealingbundles`, `tablanet`, `tarabish`, `terrace`, `madrasso`, `toepen`, `trex`, `vint`, `wizard` |
| **extra4** | `cmd/workers/extra4/main.go` | 47 | `alaska`, `anaconda`, `andarbahar`, `barbu`, `bezique`, `bhabhi`, `casinowar`, `cego`, `chemindefer`, `colourwhist`, `crazyfourpoker`, `doudizhu`, `dragontiger`, `estimation`, `flowergarden`, `fourteenout`, `guandan`, `guts`, `highcardflush`, `honeymoonbridge`, `israeliwhist`, `letitride`, `lingerlonger`, `literature`, `mendikot`, `michigan`, `mighty`, `mrsmop`, `napoleon`, `narcotic`, `ombre`, `pasur`, `perseverance`, `piquet`, `preference`, `quadrille`, `rankandfile`, `reddog`, `russianbank`, `scarto`, `sergeantmajor`, `seventwentyseven`, `sheepshead`, `shengji`, `sixbidsolo`, `trenteetquarante`, `ulti` |
