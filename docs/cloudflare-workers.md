...
| **extra2** | `cmd/workers/extra2/main.go` | 37 | `americantoad`, `beggarmyneighbour`, `bigtwo`, `bisley`, `braid`, `chineseten`, `cuarenta`, `cuckoo`, `doubleklondike`, `doubt`, `duchess`, `faro`, `fiftyone`, `gofish`, `grandfathersclock`, `kemps`, `laughandliedown`, `mighty`, `missmilligan`, `mushi`, `napoleonssquare`, `nertz`, `pigtail`, `pinochle`, `pishti`, `pontoon`, `settemezzo`, `sirtommy`, `sjavs`, `sixcardgolf`, `speed`, `spiteandmalice`, `spoons`, `tichu`, `trash`, `war`, `windmill` |
| **extra3** | `cmd/workers/extra3/main.go` | 30 | `basra`, `belote`, `bouillotte`, `bridge`, `bura`, `cego`, `congress`, `cribbage`, `fortyandeight`, `jass`, `koikoi`, `loo`, `mao`, `michigan`, `niuniu`, `ombre`, `piquet`, `primero`, `rook`, `scarto`, `sevenbridge`, `sheepshead`, `skat`, `skitgubbe`, `tablanet`, `terrace`, `toepen`, `trex`, `ulti`, `wizard` |
