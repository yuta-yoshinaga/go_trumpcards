...
| **classic** | `cmd/workers/classic/main.go` | 53 | `allfours`, `botifarra`, `briscola`, `brusquembille`, `callbreak`, `cassino`, `catchten`, `colorado`, `crazyeights`, `cucumber`, `curdsandwhey`, `daifugo`, `durak`, `egyptianratscrew`, `escoba`, `germanwhist`, `hearts`, `hokm`, `karnoffel`, `klaverjas`, `knockoutwhist`, `labellelucie`, `manille`, `marias`, `nap`, `ninetynine`, `ohhell`, `oldmaid`, `pageone`, `pitch`, `president`, `prsi`, `reversis`, `royalcotillion`, `scopa`, `scopone`, `sedma`, `sevens`, `shamrocks`, `shithead`, `simplesimon`, `slapjack`, `slobberhannes`, `solowhist`, `spades`, `spoilfive`, `tonk`, `truco`, `twotenjack`, `whist`, `germansolo`, `unsunkaruta`, `diloti` |
| **solo** | `cmd/workers/solo/main.go` | 56 | `accordion`, `acesup`, `bakersdozen`, `bakersgame`, `beleagueredcastle`, `bidwhist`, `blackhole`, `bristol`, `calculation`, `canfield`, `clocksolitaire`, `crazyquilt`, `crescent`, `cruel`, `easthaven`, `eightoff`, `euchre`, `fivehundred`, `fortress`, `fortythieves`, `fourseasons`, `freecell`, `gaps`, `golf`, `gongzhu`, `klondike`, `macau`, `memory`, `minchiate`, `montecarlo`, `osmosis`, `penguin`, `pokersquares`, `pyramid`, `russiansolitaire`, `schnapsen`, `scorpion`, `seahaventowers`, `snap`, `somerset`, `spider`, `spiderette`, `stalactites`, `tarocchini`, `teendopaanch`, `thirtyone`, `tienlen`, `tripeaks`, `tusac`, `wasp`, `whitehead`, `yaniv`, `yukon`, `zheng`, `quodlibet`, `comet` |
| **extra** | `cmd/workers/extra/main.go` | 44 | `agnes`, `bauernschnapsen`, `burraco`, `calabresella`, `canasta`, `carioca`, `chinchon`, `cinch`, `conquian`, `contractrummy`, `diplomat`, `frenchtarot`, `gaigel`, `ganjifa`, `ginrummy`, `goofspiel`, `gostop`, `hachihachi`, `handandfoot`, `indianrummy`, `kalooki`, `king`, `kingalbert`, `kingo`, `koenigrufen`, `machiavelli`, `oichokabu`, `pan`, `rummy500`, `samba`, `speculation`, `sthelena`, `streetsandalleys`, `sultan`, `threethirteen`, `troggu`, `tysiac`, `vira`, `watten`, `zwanzigerrufen`, `gleek`, `dehlapakad`, `costlycolours`, `bolivia` |
| **extra2** | `cmd/workers/extra2/main.go` | 55 | `aluette`, `americantoad`, `auldlangsyne`, `baloot`, `beggarmyneighbour`, `bideuchre`, `bigtwo`, `bisley`, `braid`, `chineseten`, `trappola`, `cribbagesquares`, `cuarenta`, `cuckoo`, `doubleklondike`, `doubt`, `duchess`, `faro`, `fiftyone`, `gofish`, `grandfathersclock`, `kemps`, `laughandliedown`, `loba`, `missmilligan`, `mushi`, `napoleonssquare`, `nertz`, `pig`, `pigtail`, `pinochle`, `pishti`, `ristikontra`, `polignac`, `pontoon`, `julepe`, `rams`, `rikken`, `slyfox`, `settemezzo`, `shelem`, `sirtommy`, `sixcardgolf`, `sjavs`, `speed`, `spiteandmalice`, `spoons`, `tichu`, `trash`, `war`, `windmill`, `zwicker`, `sutda`, `baccaratbanque`, `continentalrummy` |
| **extra3** | `cmd/workers/extra3/main.go` | 44 | `cribbage`, `bridge`, `sevenbridge`, `skat`, `congress`, `terrace`, `niuniu`, `bura`, `toepen`, `trex`, `skitgubbe`, `belote`, `fortyandeight`, `mao`, `jass`, `loo`, `basra`, `tablanet`, `bouillotte`, `primero`, `wizard`, `rook`, `koikoi`, `desmoche`, `poch`, `popejoan`, `nainjaune`, `kille`, `klaberjass`, `kaiser`, `boston`, `vint`, `tarabish`, `hasenpfeffer`, `minibridge`, `rollingstone`, `stealingbundles`, `sakura`, `saliclaw`, `bigben`, `ramsch`, `madrasso`, `coinche`, `cirulla` |
| **extra4** | `cmd/workers/extra4/main.go` | 50 | `napoleon`, `letitride`, `reddog`, `casinowar`, `dragontiger`, `mighty`, `flowergarden`, `piquet`, `highcardflush`, `doudizhu`, `barbu`, `sheepshead`, `preference`, `bezique`, `russianbank`, `ombre`, `ulti`, `trenteetquarante`, `guts`, `michigan`, `anaconda`, `scarto`, `cego`, `sixbidsolo`, `literature`, `guandan`, `shengji`, `estimation`, `israeliwhist`, `mendikot`, `bhabhi`, `sergeantmajor`, `honeymoonbridge`, `pasur`, `lingerlonger`, `andarbahar`, `colourwhist`, `chemindefer`, `crazyfourpoker`, `alaska`, `perseverance`, `fourteenout`, `narcotic`, `mrsmop`, `rankandfile`, `seventwentyseven`, `put`, `quadrille`, `schafkopf`, `piedmontesetarot` |
| **extra5** | `cmd/workers/extra5/main.go` | 0 | *(empty)* |
