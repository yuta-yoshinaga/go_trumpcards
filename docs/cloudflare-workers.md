...
| **classic** | `cmd/workers/classic/main.go` | 50 | `allfours`, `botifarra`, `briscola`, `callbreak`, `cassino`, `catchten`, `colorado`, `colourwhist`, `crazyeights`, `cucumber`, `daifugo`, `durak`, `egyptianratscrew`, `escoba`, `estimation`, `germanwhist`, `hearts`, `hokm`, `karnoffel`, `klaverjas`, `knockoutwhist`, `labellelucie`, `manille`, `marias`, `nap`, `ninetynine`, `ohhell`, `oldmaid`, `pageone`, `pitch`, `preference`, `president`, `prsi`, `reversis`, `royalcotillion`, `scopa`, `scopone`, `sedma`, `sevens`, `shithead`, `simplesimon`, `slapjack`, `slobberhannes`, `solowhist`, `spades`, `spoilfive`, `tonk`, `truco`, `twotenjack`, `whist` |
| **solo** | `cmd/workers/solo/main.go` | 50 | `accordion`, `acesup`, `bakersdozen`, `bakersgame`, `beleagueredcastle`, `bidwhist`, `blackhole`, `bristol`, `calculation`, `canfield`, `clocksolitaire`, `crazyquilt`, `crescent`, `cruel`, `easthaven`, `eightoff`, `euchre`, `fivehundred`, `fortythieves`, `fourseasons`, `freecell`, `gaps`, `golf`, `gongzhu`, `klondike`, `macau`, `memory`, `minchiate`, `montecarlo`, `osmosis`, `penguin`, `pokersquares`, `pyramid`, `russiansolitaire`, `schnapsen`, `scorpion`, `seahaventowers`, `snap`, `spider`, `spiderette`, `tarocchini`, `teendopaanch`, `thirtyone`, `tienlen`, `tripeaks`, `tusac`, `wasp`, `yaniv`, `yukon`, `zheng` |
| **extra** | `cmd/workers/extra/main.go` | 39 | `agnes`, `bhabhi`, `burraco`, `calabresella`, `canasta`, `carioca`, `chinchon`, `cinch`, `conquian`, `contractrummy`, `diplomat`, `frenchtarot`, `gaigel`, `ganjifa`, `ginrummy`, `goofspiel`, `gostop`, `hachihachi`, `handandfoot`, `indianrummy`, `kalooki`, `king`, `kingalbert`, `kingo`, `koenigrufen`, `machiavelli`, `oichokabu`, `pan`, `pasur`, `rummy500`, `samba`, `streetsandalleys`, `sultan`, `threethirteen`, `troggu`, `tysiac`, `vira`, `watten`, `zwanzigerrufen` |
| **extra2** | `cmd/workers/extra2/main.go` | 49 | `aluette`, `americantoad`, `auldlangsyne`, `baloot`, `beggarmyneighbour`, `bideuchre`, `bigtwo`, `bisley`, `braid`, `chineseten`, `cribbagesquares`, `cuarenta`, `cuckoo`, `doubleklondike`, `doubt`, `duchess`, `faro`, `fiftyone`, `gofish`, `grandfathersclock`, `guandan`, `kemps`, `laughandliedown`, `loba`, `missmilligan`, `mushi`, `napoleonssquare`, `nertz`, `pig`, `pigtail`, `pinochle`, `pishti`, `polignac`, `pontoon`, `rams`, `rikken`, `settemezzo`, `shelem`, `sirtommy`, `sixcardgolf`, `sjavs`, `speed`, `spiteandmalice`, `spoons`, `tichu`, `trash`, `war`, `windmill`, `zwicker` |
| **extra3** | `cmd/workers/extra3/main.go` | 39 | `basra`, `belote`, `boston`, `bouillotte`, `bridge`, `bura`, `congress`, `cribbage`, `desmoche`, `fortyandeight`, `hasenpfeffer`, `jass`, `kaiser`, `kille`, `klaberjass`, `koikoi`, `loo`, `mao`, `michigan`, `minibridge`, `nainjaune`, `niuniu`, `poch`, `popejoan`, `primero`, `rollingstone`, `rook`, `sakura`, `sevenbridge`, `skat`, `skitgubbe`, `stealingbundles`, `tablanet`, `tarabish`, `terrace`, `toepen`, `trex`, `vint`, `wizard` |
| **extra4** | `cmd/workers/extra4/main.go` | 32 | `anaconda`, `andarbahar`, `barbu`, `bezique`, `casinowar`, `cego`, `chemindefer`, `crazyfourpoker`, `doudizhu`, `dragontiger`, `flowergarden`, `guts`, `highcardflush`, `honeymoonbridge`, `israeliwhist`, `letitride`, `lingerlonger`, `literature`, `mendikot`, `mighty`, `napoleon`, `ombre`, `piquet`, `reddog`, `russianbank`, `scarto`, `sergeantmajor`, `sheepshead`, `shengji`, `sixbidsolo`, `trenteetquarante`, `ulti` |
