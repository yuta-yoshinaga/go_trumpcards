...
| **extra4** | `cmd/workers/extra4/main.go` | 46 | `alaska`, `anaconda`, `andarbahar`, `barbu`, `bezique`, `bhabhi`, `casinowar`, `cego`, `chemindefer`, `colourwhist`, `crazyfourpoker`, `doudizhu`, `dragontiger`, `estimation`, `flowergarden`, `fourteenout`, `guandan`, `guts`, `highcardflush`, `honeymoonbridge`, `israeliwhist`, `letitride`, `lingerlonger`, `literature`, `mendikot`, `michigan`, `mighty`, `mrsmop`, `napoleon`, `narcotic`, `ombre`, `pasur`, `perseverance`, `piquet`, `preference`, `rankandfile`, `reddog`, `russianbank`, `scarto`, `sergeantmajor`, `seventwentyseven`, `sheepshead`, `shengji`, `sixbidsolo`, `trenteetquarante`, `ulti` |
