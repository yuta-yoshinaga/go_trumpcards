...
| **extra2** | `cmd/workers/extra2/main.go` | 51 | `aluette`, `americantoad`, `auldlangsyne`, `baloot`, `beggarmyneighbour`, `bideuchre`, `bigtwo`, `bisley`, `braid`, `chineseten`, `trappola`, `cribbagesquares`, `cuarenta`, `cuckoo`, `doubleklondike`, `doubt`, `duchess`, `faro`, `fiftyone`, `gofish`, `grandfathersclock`, `kemps`, `laughandliedown`, `loba`, `missmilligan`, `mushi`, `napoleonssquare`, `nertz`, `pig`, `pigtail`, `pinochle`, `pishti`, `ristikontra`, `polignac`, `pontoon`, `rams`, `rikken`, `slyfox`, `settemezzo`, `shelem`, `sirtommy`, `sixcardgolf`, `sjavs`, `speed`, `spiteandmalice`, `spoons`, `tichu`, `trash`, `war`, `windmill`, `zwicker` |
