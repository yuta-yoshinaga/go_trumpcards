...
| **extra2** | `cmd/workers/extra2/main.go` | 27 | `beggarmyneighbour`, `bigtwo`, `bisley`, `cuarenta`, `cuckoo`, `doubleklondike`, `doubt`, `faro`, `fiftyone`, `gofish`, `grandfathersclock`, `kemps`, `mighty`, `missmilligan`, `napoleonssquare`, `nertz`, `pigtail`, `pinochle`, `pishti`, `sirtommy`, `sixcardgolf`, `speed`, `spiteandmalice`, `spoons`, `tichu`, `trash`, `war` |
