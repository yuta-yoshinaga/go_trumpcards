...
| **extra7** | `cmd/workers/extra7/main.go` | 28 | `hearts`, `canasta`, `euchre`, `fivehundred`, `bolivia`, `doudizhu`, `scopa`, `thirtyone`, `burraco`, `klaverjas`, `manille`, `scopone`, `escoba`, `handandfoot`, `conquian`, `chinchon`, `samba`, `minchiate`, `tarocchini`, `germanwhist`, `slobberhannes`, `hokm`, `pasur`, `andarbahar`, `crazyfourpoker`, `brusquembille`, `schafkopf`, `biriba` |
...
| **extra11** | `cmd/workers/extra11/main.go` | 18 | `chineseten`, `cuckoo`, `daifugo`, `fortyfives`, `marjapussi`, `marriage`, `montebank`, `mushi`, `tute`, `twentynine`, `bidwhist`, `casinowar`, `germansolo`, `guandan`, `guts`, `reddog`, `seventwentyseven`, `sheepshead` |
