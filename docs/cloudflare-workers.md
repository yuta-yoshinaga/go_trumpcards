...
|--------|-------------|-------|---------------|
| **casino** | `cmd/workers/casino/main.go` | 38 | `poker`, `holdem`, `omaha`, `omahahilo`, `bigo`, `bigohilo`, `courchevel`, `shortdeck`, `pineapple`, `crazypineapple`, `irishpoker`, `baccarat`, `indianpoker`, `threecard`, `sevencardstud`, `caribbeanstud`, `badugi`, `deucetoseven`, `razz`, `sevencardstudhilo`, `chinesepoker`, `threecardbrag`, `teenpatti`, `fivecardstud`, `openfacechinese`, `soko`, `cincinnati`, `ironcross`, `baseballpoker`, `horse`, `followthequeen`, `dramaha`, `chicago`, `eightgame`, `courchevelhilo`, `casinoholdem`, `ultimatetexasholdem`, `texasholdembonus` |
...
| **solo** | `cmd/workers/solo/main.go` | 47 | `memory`, `klondike`, `freecell`, `seahaventowers`, `cruel`, `spider`, `pyramid`, `tripeaks`, `golf`, `clocksolitaire`, `fortythieves`, `canfield`, `yukon`, `russiansolitaire`, `pokersquares`, `scorpion`, `wasp`, `accordion`, `calculation`, `bakersdozen`, `montecarlo`, `crescent`, `spiderette`, `oasispoker`, `beleagueredcastle`, `gaps`, `eightoff`, `penguin`, `acesup`, `tienlen`, `osmosis`, `schnapsen`, `yaniv`, `bristol`, `easthaven`, `bakersgame`, `blackhole`, `zheng`, `fourseasons`, `crazyquilt`, `snap`, `fortress`, `somerset`, `stalactites`, `whitehead`, `citadel`, `willothewisp` |
| **extra** | `cmd/workers/extra/main.go` | 33 | `indianrummy`, `pontoon`, `settemezzo`, `contractrummy`, `streetsandalleys`, `kingalbert`, `sultan`, `rummy500`, `ganjifa`, `vira`, `kalooki`, `threethirteen`, `gaigel`, `tysiac`, `calabresella`, `king`, `cinch`, `watten`, `carioca`, `machiavelli`, `pan`, `gostop`, `hachihachi`, `frenchtarot`, `koenigrufen`, `diplomat`, `zwanzigerrufen`, `troggu`, `sthelena`, `bauernschnapsen`, `quinze`, `matrimony`, `tapptarock` |
| **extra2** | `cmd/workers/extra2/main.go` | 41 | `bigtwo`, `speed`, `gofish`, `pigtail`, `war`, `fiftyone`, `trash`, `sirtommy`, `bisley`, `napoleonssquare`, `grandfathersclock`, `missmilligan`, `duchess`, `windmill`, `americantoad`, `spiteandmalice`, `braid`, `loba`, `sjavs`, `laughandliedown`, `sixcardgolf`, `kemps`, `pishti`, `cuarenta`, `doubleklondike`, `beggarmyneighbour`, `aluette`, `zwicker`, `bideuchre`, `auldlangsyne`, `cribbagesquares`, `polignac`, `rams`, `baloot`, `rikken`, `slyfox`, `ristikontra`, `trappola`, `julepe`, `baccaratbanque`, `tehonbiki` |
| **extra3** | `cmd/workers/extra3/main.go` | 32 | `bridge`, `sevenbridge`, `congress`, `terrace`, `niuniu`, `bura`, `toepen`, `trex`, `skitgubbe`, `fortyandeight`, `mao`, `basra`, `tablanet`, `bouillotte`, `primero`, `rook`, `koikoi`, `desmoche`, `poch`, `popejoan`, `nainjaune`, `kille`, `kaiser`, `boston`, `vint`, `rollingstone`, `stealingbundles`, `sakura`, `saliclaw`, `bigben`, `madrasso`, `cirulla` |
...
| **extra5** | `cmd/workers/extra5/main.go` | 31 | `doubt`, `napoleon`, `pinochle`, `nertz`, `pitch`, `agnes`, `macau`, `ulti`, `loo`, `wizard`, `oichokabu`, `cego`, `shelem`, `teendopaanch`, `hasenpfeffer`, `minibridge`, `goofspiel`, `kingo`, `tusac`, `speculation`, `quadrille`, `gleek`, `quodlibet`, `dehlapakad`, `diloti`, `comet`, `continentalrummy`, `batak`, `binokel`, `omi`, `tongits` |
| **extra6** | `cmd/workers/extra6/main.go` | 36 | `daifugo`, `cribbage`, `paigow`, `skat`, `mushi`, `chineseten`, `mississippistud`, `belote`, `mighty`, `tarneeb`, `tressette`, `tichu`, `bourre`, `doppelkopf`, `mus`, `tute`, `sueca`, `fortyfives`, `twentynine`, `courtpiece`, `ecarte`, `spoons`, `cuckoo`, `faro`, `jass`, `klaberjass`, `tarabish`, `pig`, `montebank`, `ramsch`, `caribbeandraw`, `coinche`, `sutda`, `costlycolours`, `marjapussi`, `marriage` |
| **extra7** | `cmd/workers/extra7/main.go` | 36 | `hearts`, `canasta`, `euchre`, `reddog`, `casinowar`, `doudizhu`, `scopa`, `thirtyone`, `fivehundred`, `burraco`, `bidwhist`, `sheepshead`, `klaverjas`, `manille`, `scopone`, `escoba`, `handandfoot`, `conquian`, `chinchon`, `guts`, `samba`, `minchiate`, `tarocchini`, `guandan`, `germanwhist`, `slobberhannes`, `hokm`, `pasur`, `andarbahar`, `crazyfourpoker`, `seventwentyseven`, `brusquembille`, `schafkopf`, `germansolo`, `bolivia`, `biriba` |
...
| **extra9** | `cmd/workers/extra9/main.go` | 0 | — |
| **extra10** | `cmd/workers/extra10/main.go` | 0 | — |
| **extra11** | `cmd/workers/extra11/main.go` | 0 | — |
