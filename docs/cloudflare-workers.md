...
| **extra2** | `cmd/workers/extra2/main.go` | 25 | `beggarmyneighbour`, `bigtwo`, `bisley`, `cuarenta`, `cuckoo`, `doubleklondike`, `doubt`, `faro`, `fiftyone`, `gofish`, `kemps`, `mighty`, `napoleonssquare`, `nertz`, `pigtail`, `pinochle`, `pishti`, `sirtommy`, `sixcardgolf`, `speed`, `spiteandmalice`, `spoons`, `tichu`, `trash`, `war` |
