...
| **extra** | `cmd/workers/extra/main.go` | 43 | `agnes`, `bauernschnapsen`, `burraco`, `calabresella`, `canasta`, `carioca`, `chinchon`, `cinch`, `conquian`, `contractrummy`, `diplomat`, `frenchtarot`, `gaigel`, `ganjifa`, `ginrummy`, `goofspiel`, `gostop`, `hachihachi`, `handandfoot`, `indianrummy`, `kalooki`, `king`, `kingalbert`, `kingo`, `koenigrufen`, `machiavelli`, `oichokabu`, `pan`, `rummy500`, `samba`, `speculation`, `sthelena`, `streetsandalleys`, `sultan`, `threethirteen`, `troggu`, `tysiac`, `vira`, `watten`, `zwanzigerrufen`, `gleek`, `dehlapakad`, `costlycolours` |
