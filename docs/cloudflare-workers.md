...
| **extra2** | `cmd/workers/extra2/main.go` | 28 | `beggarmyneighbour`, `bigtwo`, `bisley`, `cuarenta`, `cuckoo`, `doubleklondike`, `doubt`, `duchess`, `faro`, `fiftyone`, `gofish`, `grandfathersclock`, `kemps`, `mighty`, `missmilligan`, `napoleonssquare`, `nertz`, `pigtail`, `pinochle`, `pishti`, `sirtommy`, `sixcardgolf`, `speed`, `spiteandmalice`, `spoons`, `tichu`, `trash`, `war` |
