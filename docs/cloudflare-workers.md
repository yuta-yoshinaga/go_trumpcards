...
| **extra3** | `cmd/workers/extra3/main.go` | 32 | `basra`, `belote`, `bouillotte`, `bridge`, `bura`, `cego`, `congress`, `cribbage`, `desmoche`, `fortyandeight`, `jass`, `koikoi`, `loo`, `mao`, `michigan`, `niuniu`, `ombre`, `piquet`, `primero`, `rook`, `scarto`, `sevenbridge`, `sheepshead`, `skat`, `skitgubbe`, `tablanet`, `terrace`, `toepen`, `trex`, `ulti`, `wizard`, `poch` |
