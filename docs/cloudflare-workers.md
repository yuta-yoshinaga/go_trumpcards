...
| **extra3** | `cmd/workers/extra3/main.go` | 27 | `basra`, `belote`, `bouillotte`, `bridge`, `bura`, `cego`, `congress`, `cribbage`, `fortyandeight`, `jass`, `koikoi`, `loo`, `mao`, `michigan`, `niuniu`, `ombre`, `piquet`, `primero`, `rook`, `scarto`, `sevenbridge`, `sheepshead`, `skat`, `tablanet`, `terrace`, `ulti`, `wizard` |
