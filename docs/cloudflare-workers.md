...
| **extra2** | `cmd/workers/extra2/main.go` | 23 | `beggarmyneighbour`, `bigtwo`, `cuarenta`, `cuckoo`, `doubleklondike`, `doubt`, `faro`, `fiftyone`, `gofish`, `kemps`, `mighty`, `nertz`, `pigtail`, `pinochle`, `pishti`, `sirtommy`, `sixcardgolf`, `speed`, `spiteandmalice`, `spoons`, `tichu`, `trash`, `war` |
