...
| **extra3** | `cmd/workers/extra3/main.go` | 41 | `basra`, `bigben`, `belote`, `boston`, `bouillotte`, `bridge`, `bura`, `congress`, `cribbage`, `desmoche`, `fortyandeight`, `hasenpfeffer`, `jass`, `kaiser`, `kille`, `klaberjass`, `koikoi`, `loo`, `mao`, `minibridge`, `nainjaune`, `niuniu`, `poch`, `popejoan`, `primero`, `rollingstone`, `rook`, `sakura`, `saliclaw`, `sevenbridge`, `ramsch`, `skat`, `skitgubbe`, `stealingbundles`, `tablanet`, `tarabish`, `terrace`, `toepen`, `trex`, `vint`, `wizard` |
