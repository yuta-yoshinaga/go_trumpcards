...
| **extra2** | `cmd/workers/extra2/main.go` | 24 | `beggarmyneighbour`, `bigtwo`, `bisley`, `cuarenta`, `cuckoo`, `doubleklondike`, `doubt`, `faro`, `fiftyone`, `gofish`, `kemps`, `mighty`, `nertz`, `pigtail`, `pinochle`, `pishti`, `sirtommy`, `sixcardgolf`, `speed`, `spiteandmalice`, `spoons`, `tichu`, `trash`, `war` |
