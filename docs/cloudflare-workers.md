...
| **extra2** | `cmd/workers/extra2/main.go` | 36 | `americantoad`, `beggarmyneighbour`, `bigtwo`, `bisley`, `braid`, `chineseten`, `cuarenta`, `cuckoo`, `doubleklondike`, `doubt`, `duchess`, `faro`, `fiftyone`, `gofish`, `grandfathersclock`, `kemps`, `laughandliedown`, `mighty`, `missmilligan`, `mushi`, `napoleonssquare`, `nertz`, `pigtail`, `pinochle`, `pishti`, `pontoon`, `settemezzo`, `sirtommy`, `sixcardgolf`, `speed`, `spiteandmalice`, `spoons`, `tichu`, `trash`, `war`, `windmill` |
