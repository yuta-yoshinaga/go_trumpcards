...
| **extra2** | `cmd/workers/extra2/main.go` | 48 | `aluette`, `americantoad`, `auldlangsyne`, `baloot`, `beggarmyneighbour`, `bideuchre`, `bigtwo`, `bisley`, `braid`, `chineseten`, `cribbagesquares`, `cuarenta`, `cuckoo`, `doubleklondike`, `doubt`, `duchess`, `faro`, `fiftyone`, `gofish`, `grandfathersclock`, `guandan`, `kemps`, `laughandliedown`, `loba`, `mighty`, `missmilligan`, `mushi`, `napoleonssquare`, `nertz`, `pigtail`, `pinochle`, `pishti`, `polignac`, `pontoon`, `rams`, `settemezzo`, `sirtommy`, `sixbidsolo`, `sixcardgolf`, `sjavs`, `speed`, `spiteandmalice`, `spoons`, `tichu`, `trash`, `war`, `windmill`, `zwicker` |
| **extra3** | `cmd/workers/extra3/main.go` | 40 | `basra`, `belote`, `boston`, `bouillotte`, `bridge`, `bura`, `cego`, `congress`, `cribbage`, `desmoche`, `fortyandeight`, `jass`, `kaiser`, `kille`, `klaberjass`, `koikoi`, `loo`, `mao`, `michigan`, `nainjaune`, `niuniu`, `ombre`, `piquet`, `poch`, `popejoan`, `primero`, `rook`, `scarto`, `sevenbridge`, `sheepshead`, `skat`, `skitgubbe`, `tablanet`, `tarabish`, `terrace`, `toepen`, `trex`, `ulti`, `vint`, `wizard` |
