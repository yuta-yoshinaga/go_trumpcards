...
| **extra2** | `cmd/workers/extra2/main.go` | Empty — fifth size bucket added by [ADR-0036](adr/0036-fifth-sixth-worker-capacity.md) Phase 1. Phase 2 rebalances games into it. |
| **extra3** | `cmd/workers/extra3/main.go` | Empty — sixth size bucket, same as above. |
