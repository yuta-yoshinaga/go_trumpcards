...
| **extra4** | `cmd/workers/extra4/main.go` | 41 | `alaska`, `anaconda`, `andarbahar`, `barbu`, `bezique`, `bhabhi`, `casinowar`, `cego`, `chemindefer`, `colourwhist`, `crazyfourpoker`, `doudizhu`, `dragontiger`, `estimation`, `flowergarden`, `guandan`, `guts`, `seventwentyseven`, `highcardflush`, `honeymoonbridge`, `israeliwhist`, `letitride`, `lingerlonger`, `literature`, `mendikot`, `michigan`, `mighty`, `napoleon`, `ombre`, `pasur`, `piquet`, `preference`, `reddog`, `russianbank`, `scarto`, `sergeantmajor`, `sheepshead`, `shengji`, `sixbidsolo`, `trenteetquarante`, `ulti` |
