...
| **extra4** | `cmd/workers/extra4/main.go` | 49 | `napoleon`, `letitride`, `reddog`, `casinowar`, `dragontiger`, `mighty`, `flowergarden`, `piquet`, `highcardflush`, `doudizhu`, `barbu`, `sheepshead`, `preference`, `bezique`, `russianbank`, `ombre`, `ulti`, `trenteetquarante`, `guts`, `michigan`, `anaconda`, `scarto`, `cego`, `sixbidsolo`, `literature`, `guandan`, `shengji`, `estimation`, `israeliwhist`, `mendikot`, `bhabhi`, `sergeantmajor`, `honeymoonbridge`, `pasur`, `lingerlonger`, `andarbahar`, `colourwhist`, `chemindefer`, `crazyfourpoker`, `alaska`, `perseverance`, `fourteenout`, `narcotic`, `mrsmop`, `rankandfile`, `seventwentyseven`, `put`, `quadrille`, `schafkopf` |
