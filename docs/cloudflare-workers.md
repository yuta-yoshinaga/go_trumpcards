...
| **solo** | `cmd/workers/solo/main.go` | 51 | `accordion`, `acesup`, `bakersdozen`, `bakersgame`, `barbu`, `beleagueredcastle`, `bidwhist`, `blackhole`, `bristol`, `calculation`, `canfield`, `clocksolitaire`, `crazyquilt`, `crescent`, `cruel`, `easthaven`, `eightoff`, `euchre`, `fivehundred`, `fortythieves`, `fourseasons`, `freecell`, `gaps`, `golf`, `gongzhu`, `klondike`, `literature`, `macau`, `memory`, `minchiate`, `montecarlo`, `osmosis`, `penguin`, `pokersquares`, `pyramid`, `russianbank`, `russiansolitaire`, `schnapsen`, `scorpion`, `seahaventowers`, `spider`, `spiderette`, `tarocchini`, `teendopaanch`, `thirtyone`, `tienlen`, `tripeaks`, `wasp`, `yaniv`, `yukon`, `zheng` |
| **extra** | `cmd/workers/extra/main.go` | 40 | `agnes`, `anaconda`, `bhabhi`, `burraco`, `calabresella`, `canasta`, `carioca`, `chinchon`, `cinch`, `conquian`, `contractrummy`, `diplomat`, `flowergarden`, `frenchtarot`, `gaigel`, `ganjifa`, `ginrummy`, `gostop`, `guts`, `hachihachi`, `handandfoot`, `indianrummy`, `kalooki`, `king`, `kingalbert`, `koenigrufen`, `machiavelli`, `mendikot`, `oichokabu`, `pan`, `rummy500`, `samba`, `sergeantmajor`, `streetsandalleys`, `sultan`, `threethirteen`, `trenteetquarante`, `tysiac`, `vira`, `watten` |
...
| **extra3** | `cmd/workers/extra3/main.go` | 41 | `basra`, `belote`, `boston`, `bouillotte`, `bridge`, `bura`, `cego`, `congress`, `cribbage`, `desmoche`, `fortyandeight`, `hasenpfeffer`, `jass`, `kaiser`, `kille`, `klaberjass`, `koikoi`, `loo`, `mao`, `michigan`, `nainjaune`, `niuniu`, `ombre`, `piquet`, `poch`, `popejoan`, `primero`, `rook`, `scarto`, `sevenbridge`, `sheepshead`, `skat`, `skitgubbe`, `tablanet`, `tarabish`, `terrace`, `toepen`, `trex`, `ulti`, `vint`, `wizard` |
