...
|--------|-------------|-------|---------------|
| **casino** | `cmd/workers/casino/main.go` | 60 | `baccarat`, `badugi`, `banluck`, `baseballpoker`, `bigo`, `bigohilo`, `blackjack`, `blackjackswitch`, `bourre`, `caribbeanstud`, `casinoholdem`, `chinesepoker`, `cincinnati`, `courchevel`, `courtpiece`, `crazypineapple`, `deuceswild`, `deucetoseven`, `doppelkopf`, `doubleattack`, `ecarte`, `fivecardstud`, `fortyfives`, `fourcardpoker`, `freebet`, `holdem`, `horse`, `indianpoker`, `irishpoker`, `ironcross`, `jokerpoker`, `mississippistud`, `montebank`, `mus`, `oasispoker`, `omaha`, `omahahilo`, `openfacechinese`, `paigow`, `pineapple`, `poker`, `razz`, `russianpoker`, `followthequeen`, `sevencardstud`, `sevencardstudhilo`, `shortdeck`, `soko`, `spanish21`, `sueca`, `tarneeb`, `teenpatti`, `texasholdembonus`, `threecard`, `threecardbrag`, `tressette`, `tute`, `twentynine`, `ultimatetexasholdem`, `videopoker` |
