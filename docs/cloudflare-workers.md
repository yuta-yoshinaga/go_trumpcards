...
| **extra3** | `cmd/workers/extra3/main.go` | 43 | `cribbage`, `bridge`, `sevenbridge`, `skat`, `congress`, `terrace`, `niuniu`, `bura`, `toepen`, `trex`, `skitgubbe`, `belote`, `fortyandeight`, `mao`, `jass`, `loo`, `basra`, `tablanet`, `bouillotte`, `primero`, `wizard`, `rook`, `koikoi`, `desmoche`, `poch`, `popejoan`, `nainjaune`, `kille`, `klaberjass`, `kaiser`, `boston`, `vint`, `tarabish`, `hasenpfeffer`, `minibridge`, `rollingstone`, `stealingbundles`, `sakura`, `saliclaw`, `bigben`, `ramsch`, `madrasso`, `coinche` |
