...
| Tool | Version |
|------|---------|
| [Go](https://go.dev/) | 1.26.x (`go.mod` declares `go 1.25.8`, the minimum Go that TinyGo 0.42.0 supports (1.25–1.27), so CI can build the Workers with Go 1.25; `toolchain go1.26.0`) |
