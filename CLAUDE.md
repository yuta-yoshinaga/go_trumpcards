...
# euchre, pyramid, tripeaks, cribbage, threecard, ohhell
...
|--------|-------------|-------|
| **casino** | `cmd/workers/casino/main.go` | Table & poker games (blackjack, baccarat, poker, holdem, omaha, shortdeck, indianpoker, videopoker, deuceswild, jokerpoker, threecard) |
| **classic** | `cmd/workers/classic/main.go` | Trick-taking & matching (hearts, spades, euchre, napoleon, oldmaid, doubt, daifugo, sevens, crazyeights, ohhell) |
